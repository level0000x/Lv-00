...
$content = Get-Content $file -Raw -Encoding UTF8
$content = $content -replace 'bool lv00_rational_set_mpz\(', 'int lv00_rational_set_mpz('
$content = $content -replace 'bool lv00_rational_div_inplace\(', 'int lv00_rational_div_inplace('
$content = $content -replace 'bool lv00_rational_to_double\(', 'int lv00_rational_to_double('
$content = $content -replace 'return false;', 'return -1;'
$content = $content -replace 'return true;', 'return 0;'
Set-Content $file $content -NoNewline -Encoding UTF8
...
$content = Get-Content $file -Raw -Encoding UTF8
$content = $content -replace 'bool lv00_expr_get_integer\(', 'int lv00_expr_get_integer('
$content = $content -replace 'return false;', 'return -1;'
$content = $content -replace 'return true;', 'return 0;'
Set-Content $file $content -NoNewline -Encoding UTF8
