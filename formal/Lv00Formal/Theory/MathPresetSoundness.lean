...
=============================================
Corresponds to: bootstrap/src/preset/preset_linear_algebra.lv00
Theorems: gcd_exists, prime_iff, group_right_id
-/
import Mathlib

namespace Lv00Formal.Theory.MathPresetSoundness
...
end Lv00Formal.Theory.MathPresetSoundness
