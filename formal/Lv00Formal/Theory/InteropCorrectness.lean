...
namespace Lv00Formal.Theory.InteropCorrectness

open Lv00Formal.Theory.IR
open Lv00Formal.Theory.Evidence
...
def export_svg (g : ConstraintGraph) : SVGExport :=
  { svg_source := s!"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 800 600\"><g id=\"lv00-graph\">{String.join (g.nodes.map (λ n => s!"<circle id=\"{n}\" cx=\"0\" cy=\"0\" r=\"5\"/>"))}</g></svg>"
...
end Lv00Formal.Theory.InteropCorrectness
