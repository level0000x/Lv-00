...
==============================================
Corresponds to: bootstrap/src/layer1_parser/dsl_wrappers_spec.lv00
Theorems: dist_triangle, midpoint_is_on_segment
-/
import Lv00Formal.Theory.IR

namespace Lv00Formal.Theory.DSLWrappersSoundness
...
end Lv00Formal.Theory.DSLWrappersSoundness
