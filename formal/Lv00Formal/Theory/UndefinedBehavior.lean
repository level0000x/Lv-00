...
namespace Lv00Formal.Theory.UndefinedBehavior
...
/-- Full pipeline: Lv00Lang → Compiler → IR → Codegen → C execution
...
theorem full_pipeline_ub_free (prog : List Lv00Lang.Lv00Stmt) :
...
end Lv00Formal.Theory.UndefinedBehavior
