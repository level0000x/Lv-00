 ...
 */
#define REGISTER_AT(preset_name, desc, inputs, n_inputs, output, math, comp, constructive, reversible) \
    do { \
...
bool preset_algebraic_topology_register(void)
{
    ...
    REGISTER_AT(PRESET_AT_SIMPLICIAL_HOMOLOGY,
        ...
        {PRESET_TYPE_STRUCTURE, PRESET_TYPE_GROUP}, 2, PRESET_TYPE_GROUP,
    ...
    REGISTER_AT(PRESET_AT_SINGULAR_HOMOLOGY,
        ...
        {PRESET_TYPE_TOPOLOGY, PRESET_TYPE_GROUP}, 2, PRESET_TYPE_GROUP,
    ...
    REGISTER_AT(PRESET_AT_RELATIVE_HOMOLOGY,
        ...
        {PRESET_TYPE_TOPOLOGY, PRESET_TYPE_TOPOLOGY}, 2, PRESET_TYPE_GROUP,
    ...
    REGISTER_AT(PRESET_AT_MAYER_VIETORIS,
        ...
        {PRESET_TYPE_TOPOLOGY, PRESET_TYPE_TOPOLOGY, PRESET_TYPE_TOPOLOGY}, 3, PRESET_TYPE_STRUCTURE,
    ...
    REGISTER_AT(PRESET_AT_EXCISION_THEOREM,
        ...
        {PRESET_TYPE_TOPOLOGY, PRESET_TYPE_TOPOLOGY, PRESET_TYPE_TOPOLOGY}, 3, PRESET_TYPE_BOOLEAN,
    ...
    REGISTER_AT(PRESET_AT_CELLULAR_HOMOLOGY,
        ...
        {PRESET_TYPE_STRUCTURE}, 1, PRESET_TYPE_GROUP,
    ...
    REGISTER_AT(PRESET_AT_BETTI_NUMBERS,
        ...
        {PRESET_TYPE_GROUP}, 1, PRESET_TYPE_TUPLE,
    ...
    REGISTER_AT(PRESET_AT_HOMOLOGY_EXACT_SEQUENCE,
        ...
        {PRESET_TYPE_TOPOLOGY, PRESET_TYPE_TOPOLOGY}, 2, PRESET_TYPE_STRUCTURE,
    ...
    REGISTER_AT(PRESET_AT_CUP_PRODUCT,
        ...
        {PRESET_TYPE_GROUP, PRESET_TYPE_GROUP}, 2, PRESET_TYPE_GROUP,
    ...
    REGISTER_AT(PRESET_AT_DE_RHAM_COHOMOLOGY,
        ...
        {PRESET_TYPE_MANIFOLD}, 1, PRESET_TYPE_GROUP,
    ...
    REGISTER_AT(PRESET_AT_COHOMOLOGY_RING,
        ...
        {PRESET_TYPE_GROUP}, 1, PRESET_TYPE_STRUCTURE,
    ...
    REGISTER_AT(PRESET_AT_HIGHER_HOMOTOPY_GROUPS,
        ...
        {PRESET_TYPE_TOPOLOGY, PRESET_TYPE_INTEGER}, 2, PRESET_TYPE_GROUP,
    ...
    REGISTER_AT(PRESET_AT_RELATIVE_HOMOTOPY,
        ...
        {PRESET_TYPE_TOPOLOGY, PRESET_TYPE_TOPOLOGY, PRESET_TYPE_INTEGER}, 3, PRESET_TYPE_GROUP,
    ...
    REGISTER_AT(PRESET_AT_HUREWICZ_HOMOMORPHISM,
        ...
        {PRESET_TYPE_TOPOLOGY, PRESET_TYPE_INTEGER}, 2, PRESET_TYPE_HOMOMORPHISM,
    ...
    REGISTER_AT(PRESET_AT_WHITEHEAD_THEOREM,
        ...
        {PRESET_TYPE_FUNCTION, PRESET_TYPE_STRUCTURE, PRESET_TYPE_STRUCTURE}, 3, PRESET_TYPE_BOOLEAN,
    ...
    REGISTER_AT(PRESET_AT_SIMPLICIAL_COMPLEX,
        ...
        {PRESET_TYPE_SET, PRESET_TYPE_LIST}, 2, PRESET_TYPE_STRUCTURE,
    ...
    REGISTER_AT(PRESET_AT_TRIANGULATION,
        ...
        {PRESET_TYPE_TOPOLOGY}, 1, PRESET_TYPE_STRUCTURE,
        "|K| \\cong X \\text{（同胚）}",
        "O(n^2)", true, false);
    ...
    REGISTER_AT(PRESET_AT_EULER_CHARACTERISTIC,
        ...
        {PRESET_TYPE_STRUCTURE}, 1, PRESET_TYPE_INTEGER,
    ...
    REGISTER_AT(PRESET_AT_BARYCENTRIC_SUBDIVISION,
        ...
        {PRESET_TYPE_STRUCTURE}, 1, PRESET_TYPE_STRUCTURE,
