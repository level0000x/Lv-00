 ...
 */
#define REGISTER_DG(preset_name, desc, inputs, n_inputs, output, math, comp, constructive, reversible) \
    do { \
...
bool preset_differential_geometry_register(void)
{
    ...
    REGISTER_DG(PRESET_DG_ARC_LENGTH_PARAM,
        ...
        {PRESET_TYPE_PATH}, 1, PRESET_TYPE_PATH,
    ...
    REGISTER_DG(PRESET_DG_FRENET_FRAME,
        ...
        {PRESET_TYPE_PATH, PRESET_TYPE_SCALAR}, 2, PRESET_TYPE_TUPLE,
    ...
    REGISTER_DG(PRESET_DG_CURVATURE,
        ...
        {PRESET_TYPE_PATH, PRESET_TYPE_SCALAR}, 2, PRESET_TYPE_SCALAR,
    ...
    REGISTER_DG(PRESET_DG_BERTRAND_CURVE,
        ...
        {PRESET_TYPE_PATH, PRESET_TYPE_PATH}, 2, PRESET_TYPE_BOOLEAN,
    ...
    REGISTER_DG(PRESET_DG_FIRST_FUNDAMENTAL_FORM,
        ...
        {PRESET_TYPE_SURFACE}, 1, PRESET_TYPE_TUPLE,
    ...
    REGISTER_DG(PRESET_DG_GAUSS_CURVATURE,
        ...
        {PRESET_TYPE_SURFACE}, 1, PRESET_TYPE_SCALAR,
    ...
    REGISTER_DG(PRESET_DG_WEINGARTEN_MAP,
        ...
        {PRESET_TYPE_SURFACE}, 1, PRESET_TYPE_MATRIX,
    ...
    REGISTER_DG(PRESET_DG_LEVI_CIVITA_CONNECTION,
        ...
        {PRESET_TYPE_MATRIX}, 1, PRESET_TYPE_MATRIX,
    ...
    REGISTER_DG(PRESET_DG_SECTIONAL_CURVATURE,
        ...
        {PRESET_TYPE_MATRIX, PRESET_TYPE_VECTOR, PRESET_TYPE_VECTOR}, 3, PRESET_TYPE_SCALAR,
    ...
    REGISTER_DG(PRESET_DG_SCALAR_CURVATURE,
        ...
        {PRESET_TYPE_MATRIX, PRESET_TYPE_MATRIX}, 2, PRESET_TYPE_SCALAR,
        "R = g^{ij} R_{ij}",
        "O(n^2)", true, false);
    ...
    REGISTER_DG(PRESET_DG_GEODESIC_EQUATION,
        ...
        {PRESET_TYPE_SURFACE, PRESET_TYPE_POINT, PRESET_TYPE_VECTOR}, 3, PRESET_TYPE_PATH,
        "\\frac{d^2 u^k}{dt^2} + "
    ...
    REGISTER_DG(PRESET_DG_EXPONENTIAL_MAP,
        ...
        {PRESET_TYPE_POINT, PRESET_TYPE_VECTOR}, 2, PRESET_TYPE_POINT,
    ...
    REGISTER_DG(PRESET_DG_JACOBI_FIELD,
        ...
        {PRESET_TYPE_PATH, PRESET_TYPE_VECTOR}, 2, PRESET_TYPE_VECTOR,
    ...
    REGISTER_DG(PRESET_DG_TENSOR_PRODUCT,
        ...
        {PRESET_TYPE_MATRIX, PRESET_TYPE_MATRIX}, 2, PRESET_TYPE_MATRIX,
    ...
    REGISTER_DG(PRESET_DG_LIE_DERIVATIVE,
        ...
        {PRESET_TYPE_MATRIX, PRESET_TYPE_VECTOR}, 2, PRESET_TYPE_MATRIX,
