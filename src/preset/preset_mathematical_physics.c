 ...
 * @return false 注册失败
 */
static bool register_mp_preset(
    const char *name,
...
bool preset_mathematical_physics_register(void)
{
    ...
    /* 一维波动方程 d'Alembert 解 */
    {
        ...
        if (register_mp_preset(
                ...
                "一维波动方程 d'Alembert 解：u(x,t) = [f(x-ct) + f(x+ct)]/2 + (1/2c)∫g(s)ds",
    ...
    /* 波动方程分离变量解 */
    {
        ...
        if (register_mp_preset(
                ...
                "波动方程分离变量法：设 u(x,t) = X(x)T(t)，分解为空间和时间方程",
    ...
    /* 一维热传导方程 Fourier 解 */
    {
        ...
        if (register_mp_preset(
                ...
                "一维热传导方程 Fourier 级数解：u(x,t) = Σaₙexp(-n²π²αt/L²)sin(nπx/L)",
                inputs, 3, PRESET_TYPE_FUNCTION,
    ...
    /* 热传导方程基本解（热核） */
    {
        ...
        if (register_mp_preset(
                ...
                "热传导方程基本解（热核）：K(x,t) = (4παt)^(-d/2)exp(-|x|²/4αt)",
    ...
    /* 热传导方程有限差分格式 */
    {
        ...
        if (register_mp_preset(
                ...
                "热传导方程有限差分格式：显式/隐式/ Crank-Nicolson 格式",
    ...
    /* Laplace 方程分离变量解 */
    {
        ...
        if (register_mp_preset(
                ...
                "Laplace 方程分离变量法：在矩形/圆形/球形区域分离变量",
                inputs, 2, PRESET_TYPE_FUNCTION,
                "\\nabla^2 u = 0, \\quad "
    ...
    /* Poisson 方程 Green 函数法 */
    {
        ...
        if (register_mp_preset(
                ...
                "Poisson 方程 Green 函数法：u(x) = ∫G(x,y)f(y)dy + 边界项",
                inputs, 2, PRESET_TYPE_FUNCTION,
    ...
    /* 调和函数均值性质 */
    {
        ...
        if (register_mp_preset(
                ...
                "调和函数均值性质：u(x) = (1/|∂B|)∫∂B u dS = (1/|B|)∫B u dV",
    ...
    /* 定态 Schrödinger 方程求解 */
    {
        ...
        if (register_mp_preset(
                ...
                "定态 Schrödinger 方程：Ĥψ = Eψ，求解本征值问题",
    ...
    /* 含时 Schrödinger 方程演化 */
    {
        ...
        if (register_mp_preset(
                ...
                "含时 Schrödinger 方程演化：ψ(x,t) = Σcₙψₙ(x)exp(-iEₙt/ℏ)",
                inputs, 3, PRESET_TYPE_FUNCTION,
    ...
    /* 一维势阱本征值问题 */
    {
        ...
        if (register_mp_preset(
                ...
                "一维无限深势阱：Eₙ = n²π²ℏ²/(2mL²)，ψₙ = √(2/L)sin(nπx/L)",
                inputs, 2, PRESET_TYPE_TUPLE,
    ...
    /* 谐振子本征态 */
    {
        ...
        if (register_mp_preset(
                ...
                "量子谐振子：Eₙ = ℏω(n+1/2)，ψₙ 用 Hermite 多项式表示",
                inputs, 2, PRESET_TYPE_TUPLE,
    ...
    /* 静磁场 Biot-Savart 定律 */
    {
        ...
        if (register_mp_preset(
                ...
                "静磁场 Biot-Savart 定律：B = (μ₀/4π)∫J×r̂/r² dV",
                inputs, 1, PRESET_TYPE_FUNCTION,
    ...
    /* Navier-Stokes 方程（不可压缩） */
    {
        ...
        if (register_mp_preset(
                ...
                "不可压缩 Navier-Stokes 方程：ρ(∂u/∂t + u·∇u) = -∇p + μ∇²u",
                inputs, 3, PRESET_TYPE_FUNCTION,
