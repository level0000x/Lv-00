# -*- coding: utf-8 -*-
"""
Pure-Python fallback mode for Lv00.

When the C DLL (lv00_core) is unavailable, this module provides degraded
...
def enable_fallback() -> None:
    """Inject _ctypes_binding replacement into the lv00 module namespace.

    After calling this function, code that references ``lv00._ctypes_binding``
    ...
    try:
        ...
        # lv00 package not importable; nothing to inject
        return
