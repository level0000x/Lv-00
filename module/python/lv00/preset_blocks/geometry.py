...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_perpendicular_bisector
    >>> g = Graph()
    >>> p1 = g.add_point(0, 0)
    >>> p2 = g.add_point(2, 0)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_angle_bisector
    >>> g = Graph()
    >>> a = g.add_point(0, 1)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_line_intersection
    >>> g = Graph()
    >>> a = g.add_point(0, 0)
    >>> b = g.add_point(2, 2)
    >>> c = g.add_point(0, 2)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_perpendicular_line
    >>> g = Graph()
    >>> a = g.add_point(0, 0)
    >>> b = g.add_point(2, 0)
    >>> p = g.add_point(1, 1)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_parallel_line
    >>> g = Graph()
    >>> a = g.add_point(0, 0)
    >>> b = g.add_point(1, 1)
    >>> p = g.add_point(0, 1)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_distance
    >>> g = Graph()
    >>> p = g.add_point(0, 0)
    >>> q = g.add_point(3, 4)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_foot_of_perpendicular
    >>> g = Graph()
    >>> a = g.add_point(0, 0)
    >>> b = g.add_point(2, 0)
    >>> p = g.add_point(1, 2)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_circle_center
    >>> g = Graph()
    >>> a = g.add_point(1, 0)
    >>> b = g.add_point(0, 1)
    >>> c = g.add_point(-1, 0)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_circle_by_center_radius
    >>> from ..core import SymbolicCoord
    >>> g = Graph()
    >>> o = g.add_point(0, 0)
    >>> r = SymbolicCoord(5)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_circle_line_intersection
    >>> g = Graph()
    >>> o = g.add_point(0, 0)
    >>> r = 1  # 半径
    >>> a = g.add_point(-1, 0)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_tangent_line
    >>> g = Graph()
    >>> o = g.add_point(0, 0)
    >>> p = g.add_point(2, 0)
    >>> r = 1
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_centroid
    >>> g = Graph()
    >>> a = g.add_point(0, 0)
    >>> b = g.add_point(2, 0)
    >>> c = g.add_point(1, 2)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_circumcenter
    >>> g = Graph()
    >>> a = g.add_point(0, 0)
    >>> b = g.add_point(2, 0)
    >>> c = g.add_point(1, 2)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_incenter
    >>> g = Graph()
    >>> a = g.add_point(0, 0)
    >>> b = g.add_point(2, 0)
    >>> c = g.add_point(1, 2)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_orthocenter
    >>> g = Graph()
    >>> a = g.add_point(0, 0)
    >>> b = g.add_point(2, 0)
    >>> c = g.add_point(1, 2)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_excenter
    >>> g = Graph()
    >>> a = g.add_point(0, 0)
    >>> b = g.add_point(2, 0)
    >>> c = g.add_point(1, 2)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_triangle_area
    >>> g = Graph()
    >>> a = g.add_point(0, 0)
    >>> b = g.add_point(4, 0)
    >>> c = g.add_point(0, 3)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_equilateral_triangle
    >>> g = Graph()
    >>> a = g.add_point(0, 0)
    >>> b = g.add_point(2, 0)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_nine_point_circle
    >>> g = Graph()
    >>> a = g.add_point(0, 0)
    >>> b = g.add_point(2, 0)
    >>> c = g.add_point(1, 2)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_square
    >>> g = Graph()
    >>> a = g.add_point(0, 0)
    >>> b = g.add_point(2, 0)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_regular_polygon
    >>> g = Graph()
    >>> o = g.add_point(0, 0)
    >>> p = g.add_point(1, 0)
