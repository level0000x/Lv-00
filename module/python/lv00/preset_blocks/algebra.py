...
register_preset(FuncBlockSpec(
    ...
    >>> from lv00.preset_blocks import create_reflection
    >>> g = Graph()
    >>> p = g.add_point(1, 2)
    >>> a = g.add_point(0, 0)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_translation
    >>> g = Graph()
    >>> p = g.add_point(1, 2)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_rotation
    >>> import math
    >>> g = Graph()
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_homothety
    >>> g = Graph()
    >>> center = g.add_point(0, 0)
    >>> p = g.add_point(1, 1)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_circle_inversion
    >>> g = Graph()
    >>> o = g.add_point(0, 0)
    >>> p = g.add_point(2, 0)
    >>> r = 1
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv00 import Graph
    >>> from lv00.preset_blocks import create_affine_transform
    >>> g = Graph()
    >>> p = g.add_point(1, 0)
    >>> # 旋转 90° 的仿射变换
