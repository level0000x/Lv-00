...
register_preset(FuncBlockSpec(
    ...
    >>> from lv.preset_func_blocks import create_reflection
    >>> g = Graph()
    >>> p = g.add_point(1, 2)
    >>> a = g.add_point(0, 0)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv import Graph
    >>> from lv.preset_func_blocks import create_translation
    >>> g = Graph()
    >>> p = g.add_point(1, 2)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv import Graph
    >>> from lv.preset_func_blocks import create_rotation
    >>> g = Graph()
