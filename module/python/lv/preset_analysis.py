...
register_preset(FuncBlockSpec(
    ...
    >>> from lv.preset_func_blocks import create_circle_center
    >>> g = Graph()
    >>> a = g.add_point(1, 0)
    >>> b = g.add_point(0, 1)
    >>> c = g.add_point(-1, 0)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv import Graph
    >>> from lv.preset_func_blocks import create_circle_line_intersection
    >>> g = Graph()
    >>> o = g.add_point(0, 0)
    >>> r = 1  # 半径
    >>> a = g.add_point(-1, 0)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv import Graph
    >>> from lv.preset_func_blocks import create_tangent_line
    >>> g = Graph()
    >>> o = g.add_point(0, 0)
    >>> p = g.add_point(2, 0)
    >>> r = 1
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv import Graph
    >>> from lv.preset_func_blocks import create_centroid
    >>> g = Graph()
    >>> a = g.add_point(0, 0)
    >>> b = g.add_point(2, 0)
    >>> c = g.add_point(1, 2)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv import Graph
    >>> from lv.preset_func_blocks import create_orthocenter
    >>> g = Graph()
    >>> a = g.add_point(0, 0)
    >>> b = g.add_point(2, 0)
    >>> c = g.add_point(1, 2)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv import Graph
    >>> from lv.preset_func_blocks import create_circumcenter
    >>> g = Graph()
    >>> a = g.add_point(0, 0)
    >>> b = g.add_point(2, 0)
    >>> c = g.add_point(1, 2)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv import Graph
    >>> from lv.preset_func_blocks import create_incenter
    >>> g = Graph()
    >>> a = g.add_point(0, 0)
    >>> b = g.add_point(2, 0)
    >>> c = g.add_point(1, 2)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv import Graph
    >>> from lv.preset_func_blocks import create_area
    >>> g = Graph()
    >>> a = g.add_point(0, 0)
    >>> b = g.add_point(4, 0)
    >>> c = g.add_point(0, 3)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv import Graph
    >>> from lv.preset_func_blocks import create_equilateral_triangle
    >>> g = Graph()
    >>> a = g.add_point(0, 0)
    >>> b = g.add_point(2, 0)
...
register_preset(FuncBlockSpec(
    ...
    example_usage="""
    >>> from lv import Graph
    >>> from lv.preset_func_blocks import create_triangle_centroid
    >>> g = Graph()
    >>> a = g.add_point(0, 0)
    >>> b = g.add_point(2, 0)
    >>> c = g.add_point(1, 2)
