...
/-- Opaque type for C lv00_point_t handle -/
constant CPoint : Type

/-- Opaque type for C lv00_line_t handle -/
constant CLine : Type

/-- Opaque type for C lv00_circle_t handle -/
constant CCircle : Type

/-- Opaque type for C lv00_constraint_graph_t handle -/
constant CConstraintGraph : Type

/-- Opaque type for C lv00_proof_t handle -/
...
/-- Create a C point from coordinates.
    ...
    ```c
    lv00_point_t* lv00_point_create(double x, double y, double z);
    ``` -/
@[extern "lv00_ffi_point_create"]
...
/-- Get coordinates from a C point.
    ...
    Corresponding C function:
    ```c
    void lv00_point_get(lv00_point_t* p, double* x, double* y, double* z);
    ``` -/
@[extern "lv00_ffi_point_get"]
...
/-- Free a C point.
    ...
    Corresponding C function:
    ```c
    void lv00_point_free(lv00_point_t* p);
    ``` -/
@[extern "lv00_ffi_point_free"]
...
/-- Create a C line from two points.
    ...
    Corresponding C function:
    ```c
    lv00_line_t* lv00_line_create(lv00_point_t* p1, lv00_point_t* p2);
    ``` -/
@[extern "lv00_ffi_line_create"]
...
/-- Check if a point lies on a line.
    ...
    Corresponding C function:
    ```c
    bool lv00_line_contains(lv00_line_t* l, lv00_point_t* p);
    ``` -/
@[extern "lv00_ffi_line_contains"]
...
/-- Free a C line.
    ...
    Corresponding C function:
    ```c
    void lv00_line_free(lv00_line_t* l);
    ``` -/
@[extern "lv00_ffi_line_free"]
...
/-- Find intersection of two lines.
    ...
    Corresponding C function:
    ```c
    lv00_point_t* lv00_line_intersection(lv00_line_t* l1, lv00_line_t* l2);
    ``` -/
@[extern "lv00_ffi_line_intersection"]
...
/-- Check if three points are collinear.
    ...
    ``` -/
@[extern "lv00_ffi_points_collinear"]
...
/-- Check if two lines are parallel.
    ...
    Corresponding C function:
    ```c
    bool lv00_lines_parallel(lv00_line_t* l1, lv00_line_t* l2);
    ``` -/
@[extern "lv00_ffi_lines_parallel"]
...
/-- Check if two lines are perpendicular.
    ...
    Corresponding C function:
    ```c
    bool lv00_lines_perpendicular(lv00_line_t* l1, lv00_line_t* l2);
    ``` -/
@[extern "lv00_ffi_lines_perpendicular"]
...
/-- Create an empty constraint graph.
    ...
    Corresponding C function:
    ```c
    lv00_constraint_graph_t* lv00_graph_create(void);
    ``` -/
@[extern "lv00_ffi_graph_create"]
...
/-- Add a point to the constraint graph.
    ...
    Corresponding C function:
    ```c
    lv00_node_id_t lv00_graph_add_point(lv00_constraint_graph_t* g, lv00_point_t* p);
    ``` -/
@[extern "lv00_ffi_graph_add_point"]
...
/-- Add a collinearity constraint.
    ...
    Corresponding C function:
    ```c
    bool lv00_graph_add_collinear(lv00_constraint_graph_t* g, 
                                   lv00_node_id_t a, 
                                   lv00_node_id_t b, 
                                   lv00_node_id_t c);
    ``` -/
@[extern "lv00_ffi_graph_add_collinear"]
...
/-- Normalize the constraint graph.
    ...
    Corresponding C function:
    ```c
    bool lv00_graph_normalize(lv00_constraint_graph_t* g);
    ``` -/
@[extern "lv00_ffi_graph_normalize"]
...
/-- Check if the graph is consistent.
    ...
    Corresponding C function:
    ```c
    bool lv00_graph_is_consistent(lv00_constraint_graph_t* g);
    ``` -/
@[extern "lv00_ffi_graph_is_consistent"]
...
/-- Free a constraint graph.
    ...
    Corresponding C function:
    ```c
    void lv00_graph_free(lv00_constraint_graph_t* g);
    ``` -/
@[extern "lv00_ffi_graph_free"]
