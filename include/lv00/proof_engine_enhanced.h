 ...
 * @return 是否成功
 */
bool lv00_trace_node_add_child(Lv00ProofTraceNode *parent, Lv00ProofTraceNode *child);
 ...
 * @param status 状态
 */
void lv00_trace_node_set_status(Lv00ProofTraceNode *node, Lv00TraceNodeStatus status);
