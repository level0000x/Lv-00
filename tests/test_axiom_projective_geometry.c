...
static void test_templates(void)
{
    ...
    TEST_ASSERT(pkg->template_count == EXPECTED_TEMPLATE_COUNT,
        "should have 42 constraint templates");
    ...
    const char *expected_templates[] = {
        ...
        "join_of_two_points",
        "meet_of_two_lines",
        "existence_of_triangle_projective",
        /* Group II: Dimension and Extension Axioms (4) */
        "existence_of_complete_quadrangle",
        "line_has_three_points",
        "point_has_three_lines",
        "veblen_axiom",
        ...
        "line_through_point_meeting_line",
        "harmonic_conjugate",
        "intersection_of_line_with_line",
        "cross_ratio",
        "perspectivity",
        "diagonal_triangle_of_quadrangle",
        "dual_configuration",
        "pole_polar_construction",
        ...
        "conic_through_five_points",
        "tangent_to_conic",
        "pascal_theorem",
        "brianchon_theorem",
        /* Group VIII: Coordinate Field Construction (4) */
        "field_addition_geometric",
        "field_multiplication_geometric",
        "field_additive_inverse",
        "field_multiplicative_inverse",
        /* Group IX: Higher-Dimensional (3) */
        "join_point_line_to_plane",
        "meet_of_two_planes",
        "desargues_provable_in_3d",
        /* Group X: Derived Theorems (5) */
        "dual_desargues_theorem",
        "harmonic_conjugate_uniqueness",
        "complete_quadrilateral_theorem",
        "projectivity_uniqueness",
...
static void test_unconstructible_problems(void)
{
    ...
    struct {
        ...
        { "existence_of_finite_projective_plane_non_prime_power",
          "open_problem", 3, true },
        { "classification_of_finite_projective_planes",
          "wildly_open", 2, true },
        { "coordinate_field_of_non_desarguesian_plane",
          "non_associative_algebra", 2, true },
        { "constructing_midpoint_with_straightedge_only",
          "metric_construction", 2, true },
        { "trisection_of_angle_projective",
          "cubic_equation_solving", 2, true },
        { "pappus_implies_field_commutativity",
          "algebraic_equivalence", 3, true },
        { "order_of_largest_unknown_finite_projective_plane",
          "open_problem", 2, true },
    };
...
static void test_logical_framework(void)
{
    ...
    TEST_ASSERT(pkg->bottom_geometry != NULL &&
                strcmp(pkg->bottom_geometry, "projective_plane_incidence") == 0,
