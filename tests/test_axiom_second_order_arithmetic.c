...
static void test_templates(void)
{
    ...
    TEST_ASSERT(pkg->template_count == EXPECTED_TEMPLATE_COUNT,
        "should have 112 constraint templates");
...
static void test_unconstructible_problems(void)
{
    ...
    struct {
        ...
        { "consistency_of_Z2",
          "Gödel's second incompleteness theorem", 2, true },
        { "true_arithmetical_sentences",
          "Tarski's undefinability of truth", 2, true },
        { "goodstein_theorem",
          "Independent of PA, provable in Z₂ (in fact in ACA₀)", 2, true },
        { "paris_harrington_theorem",
          "Independent of PA, equivalent to ACA₀ over RCA₀", 2, true },
        { "kruskal_tree_theorem",
          "Independent of ACA₀, provable in ATR₀", 2, true },
        { "frasse_conjecture_wqo",
          "Equivalent to ATR₀ over RCA₀ (Laver 1971)", 2, true },
        { "pi11_comprehension_consistency",
          "Transcends Π¹₁-CA₀ (Gödel's second incompleteness)", 2, true },
        { "full_Z2_consistency",
          "Unprovable in Z₂ (Gödel's second incompleteness)", 2, true },
        { "wkl0_vs_rca0_independence",
          "WKL₀ is Π¹₁-conservative over RCA₀ but not Σ¹₁-conservative", 2, true },
        { "ramsey_theory_RT22_complexity",
          "RT²₂ is between RCA₀ and WKL₀ (exact strength open)", 2, false },
        { "determinacy_of_Borel_games",
          "Provable in Z₂ but strength exceeds Π¹₁-CA₀ (Martin 1975)", 2, true },
        { "projective_determinacy",
          "Not provable in Z₂; requires large cardinal axioms", 2, true },
    };
...
static void test_logical_framework(void)
{
    ...
    TEST_ASSERT(pkg->bottom_geometry != NULL &&
                strcmp(pkg->bottom_geometry, "second_order_arithmetic_natural_numbers") == 0,
...
static void test_big_five_subsystems(void)
{
    ...
    const char *aca0_equivs[] = {
        "bolzano_weierstrass",
        "supremum_bounded_sequence",
        "cantor_bendixson_theorem",
        "algebraic_closure_countable_field",
    ...
    const char *atr0_equivs[] = {
        "ranking_function_existence",
        "well_ordering_comparability",
        "perfect_set_theorem_closed",
        "open_determinacy",
        "frasse_conjecture",
    };
