...
static void test_save_load_roundtrip(void)
{
    ...
    TEST_ASSERT(strcmp(pkg2->name, "functional_analysis") == 0,
...
static void test_key_templates(void)
{
    ...
    /* Normed space core */
    const char *normed_core[] = {
        "normed_vector_space", "banach_space", "dual_space"
    };
    ...
    /* Hilbert space core */
    const char *hilbert_core[] = {
        "inner_product_space", "hilbert_space", "orthonormal_basis"
    };
