...
static void test_string_conversions(void)
{
    ...
    /* 测试类别字符串 */
    TEST_ASSERT_STR_EQ(func_block_preset_category_string(PRESET_CATEGORY_CONSTRUCTION), 
                       "几何构造");
    TEST_ASSERT_STR_EQ(func_block_preset_category_string(PRESET_CATEGORY_MEASUREMENT), 
                       "度量计算");
    TEST_ASSERT_STR_EQ(func_block_preset_category_string(PRESET_CATEGORY_TRANSFORMATION), 
                       "几何变换");
    TEST_ASSERT_STR_EQ(func_block_preset_category_string(PRESET_CATEGORY_ALGEBRAIC), 
                       "代数运算");
    TEST_ASSERT_STR_EQ(func_block_preset_category_string(PRESET_CATEGORY_LOGIC), 
                       "逻辑推导");
    ...
    int len = func_block_preset_properties_string(
        PRESET_PROPERTY_DETERMINISTIC | PRESET_PROPERTY_CONTINUOUS | PRESET_PROPERTY_CONSTRUCTIVE,
