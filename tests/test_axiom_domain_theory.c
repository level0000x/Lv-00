...
static void test_load_from_file(void)
{
    ...
    TEST_ASSERT(pkg->name != NULL && strcmp(pkg->name, "domain_theory") == 0,
        "package name should be 'domain_theory'");
...
static void test_templates(void)
{
    ...
    TEST_ASSERT(pkg->template_count == EXPECTED_TEMPLATE_COUNT,
        "should have 69 constraint templates");
    ...
    const char *expected_templates[] = {
        ...
        "pointwise_order",
        "function_space_dcpo",
        "currying_isomorphism",
        /* Group IV: Way-Below */
        "way_below_implies_below",
        "directed_interpolation",
        "compact_element",
        "way_below_monotone",
        "compact_iff_way_below_self",
        "bottom_is_compact",
        "way_below_directed",
        ...
        "kleene_chain",
        "least_fixed_point",
        "pataraia_fixed_point",
        "bourbaki_witt_fixed_point",
        "fixed_point_fusion",
        "rolling_rule",
        "lfp_uniqueness",
        ...
        "product_domain",
        "disjoint_sum_domain",
        "function_space_construction",
        "lifted_construction",
        "strict_function_space",
        "plotkin_powerdomain",
        "hoare_powerdomain",
        "smyth_powerdomain",
        "domain_equation",
        ...
        "compute_directed_sup",
        "compute_kleene_fixpoint",
        "construct_scott_topology",
        "construct_product",
        "construct_lifted",
        "verify_scott_continuity",
        "compute_way_below",
        "find_compact_elements",
        NULL
    };
...
static void test_logical_framework(void)
{
    ...
    TEST_ASSERT(pkg->bottom_geometry != NULL &&
                strcmp(pkg->bottom_geometry, "pointed_dcpo_least_element") == 0,
    ...
    TEST_ASSERT(pkg->negation_encoding != NULL &&
                strcmp(pkg->negation_encoding,
                       "classical_complement_in_information_order") == 0,
...
static void test_domain_theory_properties(void)
{
    ...
    TEST_ASSERT(bot != NULL && bot_u != NULL,
        "should have bottom element axiom and uniqueness");
    ...
    TEST_ASSERT(mono != NULL && dsp != NULL && sc != NULL,
        "should have Scott continuity axioms");
    ...
    TEST_ASSERT(wb != NULL && di != NULL && cmp != NULL,
        "should have way-below relation and compact element axioms");
    ...
    TEST_ASSERT(st != NULL && so != NULL && lt != NULL,
        "should have Scott topology templates");
    ...
    TEST_ASSERT(prod != NULL && sum != NULL && fsc != NULL &&
                ppd != NULL && hpd != NULL && spd != NULL,
...
static void test_domain_hierarchy(void)
{
    ...
    TEST_ASSERT(ki != NULL && kc != NULL && rr != NULL,
        "should have Kleene iteration machinery");
