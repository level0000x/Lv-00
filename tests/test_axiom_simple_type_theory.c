...
#define AXIOM_PKG_PATH "axiom_packages/simple_type_theory.lvz"
#define SAVE_TEST_PATH "axiom_packages/simple_type_theory_test_save.lvz"
...
static void test_logical_framework(void)
{
    ...
    TEST_ASSERT(strstr(pkg->negation_encoding, "empty_type") != NULL ||
                strstr(pkg->negation_encoding, "false") != NULL,
...
static void test_save_load_roundtrip(void)
{
    ...
    TEST_ASSERT(strcmp(pkg2->name, "simple_type_theory") == 0,
...
static void test_key_templates(void)
{
    ...
    const char *core_terms[] = {
        "variable", "lambda_abstraction", "application"
    };
    ...
    const char *typing_rules[] = {
        "var_rule", "abs_rule", "app_rule"
    };
