...
static void test_templates(void)
{
    ...
    TEST_ASSERT(pkg->template_count == EXPECTED_TEMPLATE_COUNT,
        "should have 38 constraint templates");
...
static void test_logical_framework(void)
{
    ...
    TEST_ASSERT(strstr(pkg->bottom_geometry, "algebraic_set") != NULL ||
                strstr(pkg->bottom_geometry, "affine_space") != NULL,
...
static void test_save_load_roundtrip(void)
{
    ...
    TEST_ASSERT(strcmp(pkg2->name, "algebraic_geometry") == 0,
...
static void test_key_templates(void)
{
    ...
    const char *affine_core[] = {
        "affine_space", "algebraic_set", "coordinate_ring"
    };
    ...
    const char *proj_core[] = {
        "projective_space", "projective_variety", "homogeneous_coordinates"
    };
