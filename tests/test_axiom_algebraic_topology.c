...
#define AXIOM_PKG_PATH "axiom_packages/algebraic_topology.lvz"
#define SAVE_TEST_PATH "axiom_packages/algebraic_topology_test_save.lvz"
...
static void test_save_load_roundtrip(void)
{
    ...
    TEST_ASSERT(strcmp(pkg2->name, "algebraic_topology") == 0,
...
static void test_key_templates(void)
{
    ...
    const char *fundamental_group_core[] = {
        "fundamental_group", "fundamental_groupoid",
    ...
    /* Homology core */
    const char *homology_core[] = {
        "simplicial_complex", "simplicial_homology",
        "chain_complex", "boundary_operator",
        "homology_group", "singular_homology"
    };
    ...
    const char *cohomology_ops[] = {
        "cup_product", "cohomology_ring",
        "poincare_duality", "de_rham_cohomology"
    };
