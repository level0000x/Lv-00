...
#define AXIOM_PKG_PATH "axiom_packages/game_theory.lvz"
#define SAVE_TEST_PATH "axiom_packages/game_theory_test_save.lvz"
...
static void test_load_from_file(void)
{
    ...
    TEST_ASSERT(pkg->name != NULL && strcmp(pkg->name, "game_theory") == 0,
        "package name should be 'game_theory'");
...
static void test_logical_framework(void)
{
    ...
    TEST_ASSERT(pkg->bottom_geometry != NULL &&
                strcmp(pkg->bottom_geometry, "utility_space_convex_polytope") == 0,
        "bottom_geometry should be 'utility_space_convex_polytope'");
    printf("  bottom_geometry: %s\n", pkg->bottom_geometry);

    TEST_ASSERT(pkg->negation_encoding != NULL &&
                strcmp(pkg->negation_encoding, "classical_deviation_negation") == 0,
...
static void test_game_theory_coherence(void)
{
    ...
    const char *structure[] = {
        "player_set", "strategy_space", "strategy_profile",
        "utility_function", "game_tuple",
        NULL
    };
    ...
    const char *rationality[] = {
        "preference_completeness", "preference_transitivity",
        "expected_utility", "independence_axiom", "continuity_axiom",
        NULL
    };
    ...
    const char *nash[] = {
        "best_response", "nash_equilibrium", "nash_existence_finite",
        "mixed_strategy", "expected_payoff_mixed", "mixed_strategy_support",
        NULL
    };
    ...
    const char *zerosum[] = {
        "zero_sum_condition", "maximin", "minimax",
        "minimax_theorem", "saddle_point", "game_value",
        NULL
    };
    ...
    const char *cooperative[] = {
        "characteristic_function", "grand_coalition", "imputation",
        "core", "bondareva_shapley_theorem",
        "shapley_value", "shapley_efficiency", "shapley_symmetry",
        "shapley_dummy", "shapley_additivity",
        NULL
    };
    ...
    const char *dominance[] = {
        "strict_dominance", "weak_dominance",
        "iterated_elimination", "pareto_efficiency",
        NULL
    };
    ...
    const char *extensive[] = {
        "game_tree", "information_set",
        "perfect_information", "imperfect_information",
        "subgame_perfect_equilibrium", "backward_induction",
        NULL
    };
    ...
    const char *evolutionary[] = {
        "evolutionarily_stable_strategy", "fitness",
        "replicator_dynamics", "nash_implies_ess",
        NULL
    };
    ...
    const char *mechanism[] = {
        "social_choice_function", "incentive_compatibility",
        "vcg_mechanism", "arrow_impossibility",
        NULL
    };
    ...
    const char *repeated[] = {
        "repeated_game", "folk_theorem",
        "correlated_equilibrium", "trembling_hand_perfect",
        "proper_equilibrium",
        NULL
    };
