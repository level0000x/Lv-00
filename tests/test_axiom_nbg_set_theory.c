...
static void test_logical_framework(void)
{
    ...
    TEST_ASSERT(strstr(pkg->bottom_geometry, "proper_class") != NULL,
        "bottom_geometry should contain 'proper_class'");
...
static void test_save_load_roundtrip(void)
{
    ...
    TEST_ASSERT(strcmp(pkg2->name, "nbg_set_theory") == 0,
...
static void test_key_templates(void)
{
    ...
    const char *class_axioms[] = {
        "class_extensionality", "class_pair_existence",
        "class_intersection", "class_complement", "class_domain"
    };
    ...
    const char *set_axioms[] = {
        "infinity", "union", "power_set", "replacement", "regularity"
    };
