...
#define AXIOM_PKG_PATH "axiom_packages/ring_theory.lvz"
#define SAVE_TEST_PATH "axiom_packages/ring_theory_test_save.lvz"
...
static void test_load_from_file(void)
{
    ...
    TEST_ASSERT(pkg->name != NULL && strcmp(pkg->name, "ring_theory") == 0,
        "package name should be 'ring_theory'");
...
static void test_logical_framework(void)
{
    ...
    TEST_ASSERT(pkg->bottom_geometry != NULL &&
                strcmp(pkg->bottom_geometry, "ring_theory_abstract") == 0,
...
static void test_ring_axiom_coherence(void)
{
    ...
    const char *core_axioms[] = {
        "additive_closure", "multiplicative_closure",
        "additive_associativity", "multiplicative_associativity",
        "additive_identity", "multiplicative_identity",
        "additive_inverse", "additive_commutativity",
