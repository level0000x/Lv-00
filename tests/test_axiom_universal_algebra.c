...
#define AXIOM_PKG_PATH "axiom_packages/universal_algebra.lvz"
#define SAVE_TEST_PATH "axiom_packages/universal_algebra_test_save.lvz"
...
static void test_templates(void)
{
    ...
    TEST_ASSERT(pkg->template_count == EXPECTED_TEMPLATE_COUNT,
        "should have 60 constraint templates");
...
static void test_logical_framework(void)
{
    ...
    TEST_ASSERT(pkg->bottom_geometry != NULL &&
                strcmp(pkg->bottom_geometry, "universal_algebra_equational") == 0,
        "bottom_geometry should be 'universal_algebra_equational'");
    printf("  bottom_geometry: %s\n", pkg->bottom_geometry);

    TEST_ASSERT(pkg->negation_encoding != NULL &&
                strcmp(pkg->negation_encoding, "equational_equality") == 0,
...
static void test_external_refs(void)
{
    ...
    struct {
        ...
        { "word_problem_for_varieties",
          "https://en.wikipedia.org/wiki/Word_problem" },
        { "equational_theory_equivalence",
          "https://en.wikipedia.org/wiki/Word_problem" },
        { "finite_basis_problem",
          "https://en.wikipedia.org/wiki/Universal_algebra" },
        { "variety_equivalence",
          "https://en.wikipedia.org/wiki/Variety" },
        { "congruence_lattice_recognition",
          "https://en.wikipedia.org/wiki/Universal_algebra" },
        { "free_algebra_finiteness",
          "https://en.wikipedia.org/wiki/Universal_algebra" },
        { "knuth_bendix_completion_termination",
          "https://en.wikipedia.org/wiki/Word_problem" },
        { "equational_unification",
          "https://en.wikipedia.org/wiki/Word_problem" },
    };
...
static void test_template_categories(void)
{
    ...
    const char *category_templates[] = {
        ...
        /* Congruence */
        "congruence_identity", "congruence_total", "congruence_lattice",
        /* Isomorphism theorems */
        "first_isomorphism_theorem", "second_isomorphism_theorem",
        "third_isomorphism_theorem",
        /* Mal'cev conditions */
        "malcev_term", "congruence_permutability",
        "congruence_modularity", "congruence_distributivity",
        /* Variety */
        "hsp_theorem", "subdirect_representation",
        "subdirectly_irreducible", "equational_basis",
        /* Term rewriting */
        "confluence", "termination", "knuth_bendix_completion",
    };
