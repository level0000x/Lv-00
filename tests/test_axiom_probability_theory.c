...
#define AXIOM_PKG_PATH "axiom_packages/probability_theory.lvz"
#define SAVE_TEST_PATH "axiom_packages/probability_theory_test_save.lvz"
...
static void test_templates(void)
{
    ...
    const char *expected_templates[] = {
        ...
        "conditional_probability_def",
        "multiplication_rule",
        "law_total_probability",
        "bayes_theorem",
        "chain_rule_conditional",
        "conditional_probability_bounds",
        /* Group IV: Independence */
        "independence_definition",
        "independence_complement",
        "mutual_independence",
        "pairwise_independence",
        "conditional_independence",
        "sigma_algebra_independence",
        /* Group V: Random Variables */
        "random_variable_measurable",
        ...
        "expected_value_definition",
        "expectation_linearity",
        "expectation_of_function",
        "variance_definition",
        "variance_formula",
...
static void test_unconstructibles(void)
{
    ...
    const char *expected_unconstructibles[] = {
        ...
        "normality_of_pi",
        "exact_probability_continuous",
        "bayesian_exact_inference",
        "optimal_stopping_general",
        "random_walk_recurrence_general",
...
static void test_round_trip(void)
{
    ...
    printf("  Round-trip: '%s' v%s, %d templates, %d unconstructibles\n",
           pkg2->name, pkg2->version, pkg2->template_count, pkg2->unconstructible_count);
...
static void test_external_refs(void)
{
    ...
    TEST_ASSERT(uc1 != NULL && uc1->external_ref != NULL,
        "martin_lof_randomness_test should have external_ref");
    TEST_ASSERT(strstr(uc1->external_ref, "wikipedia.org") != NULL,
        "external_ref should contain wikipedia.org");
    ...
    TEST_ASSERT(uc2 != NULL && uc2->external_ref != NULL,
        "normality_of_pi should have external_ref");
