...
#define AXIOM_PKG_PATH "axiom_packages/number_theory.lvz"
#define SAVE_TEST_PATH "axiom_packages/number_theory_test_save.lvz"
...
static void test_load_from_file(void)
{
    ...
    TEST_ASSERT(pkg->name != NULL && strcmp(pkg->name, "number_theory") == 0,
        "package name should be 'number_theory'");
...
static void test_logical_framework(void)
{
    ...
    TEST_ASSERT(strstr(pkg->bottom_geometry, "divisibility") != NULL ||
                strstr(pkg->bottom_geometry, "prime_number") != NULL,
...
static void test_save_load_roundtrip(void)
{
    ...
    TEST_ASSERT(strcmp(pkg2->name, "number_theory") == 0,
...
static void test_key_templates(void)
{
    ...
    const char *elementary_core[] = {
        "divisibility", "congruence", "euler_totient",
        "chinese_remainder", "quadratic_residue"
    };
    ...
    const char *algebraic_core[] = {
        "ring_of_integers", "ideal_theory", "class_number"
    };
