...
#define AXIOM_PKG_PATH "axiom_packages/hyperbolic_geometry.lvz"
#define SAVE_TEST_PATH "axiom_packages/hyperbolic_geometry_test_save.lvz"
...
static void test_templates(void)
{
    ...
    TEST_ASSERT(pkg->template_count == EXPECTED_TEMPLATE_COUNT,
        "should have 29 constraint templates");
...
static void test_unconstructibles(void)
{
    ...
    const char *expected_uc[] = {
        "squaring_the_circle_hyperbolic",
        "angle_trisection_hyperbolic",
        "doubling_the_cube_hyperbolic",
        "regular_polygon_hyperbolic",
        "area_of_triangle_trisection",
        "constructible_angle_characterization",
    };
...
static void test_logical_framework(void)
{
    ...
    TEST_ASSERT(strcmp(pkg->bottom_geometry, "hyperbolic_plane") == 0,
        "bottom_geometry should be 'hyperbolic_plane'");
...
static void test_save_load_roundtrip(void)
{
    ...
    TEST_ASSERT(strcmp(pkg2->name, "hyperbolic_geometry") == 0,
...
static void test_key_templates(void)
{
    ...
    TEST_ASSERT(sas->param_count == 6,
        "SAS_congruence should have 6 parameters");
