...
static void test_logical_framework(void)
{
    ...
    TEST_ASSERT(strstr(pkg->negation_encoding, "complement") != NULL ||
                strstr(pkg->negation_encoding, "metric") != NULL,
...
static void test_save_load_roundtrip(void)
{
    ...
    TEST_ASSERT(strcmp(pkg2->name, "differential_geometry") == 0,
...
static void test_key_templates(void)
{
    ...
    const char *manifold_core[] = {
        "smooth_manifold", "chart_atlas", "smooth_map",
    ...
    const char *riemannian_core[] = {
        "riemannian_metric", "geodesic", "exponential_map"
    };
