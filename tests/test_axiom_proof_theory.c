...
#define AXIOM_PKG_PATH "axiom_packages/proof_theory.lvz"
#define SAVE_TEST_PATH "axiom_packages/proof_theory_test_save.lvz"
...
static void test_load_from_file(void)
{
    ...
    TEST_ASSERT(pkg->name != NULL && strcmp(pkg->name, "proof_theory") == 0,
        "package name should be 'proof_theory'");
...
static void test_logical_framework(void)
{
    ...
    TEST_ASSERT(strstr(pkg->bottom_geometry, "sequent") != NULL ||
                strstr(pkg->bottom_geometry, "proof") != NULL,
...
static void test_save_load_roundtrip(void)
{
    ...
    TEST_ASSERT(strcmp(pkg2->name, "proof_theory") == 0,
