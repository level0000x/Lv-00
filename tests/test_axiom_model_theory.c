...
static void test_load_from_file(void)
{
    ...
    TEST_ASSERT(pkg->name != NULL && strcmp(pkg->name, "model_theory") == 0,
        "package name should be 'model_theory'");
...
static void test_templates(void)
{
    ...
    TEST_ASSERT(pkg->template_count == EXPECTED_TEMPLATE_COUNT,
        "should have 35 constraint templates");
...
static void test_save_load_roundtrip(void)
{
    ...
    TEST_ASSERT(strcmp(pkg2->name, "model_theory") == 0,
...
static void test_key_templates(void)
{
    ...
    const char *fol_basics[] = {
        "first_order_language", "structure_model",
        "satisfaction_relation", "theory",
    ...
    /* Classical theorems */
    const char *classical_theorems[] = {
        "completeness_theorem", "compactness_theorem",
        "downward_lowenheim_skolem", "upward_lowenheim_skolem",
        "vaught_test", "omitting_types_theorem",
    ...
    /* Stability theory */
    const char *stability_core[] = {
        "complete_type", "type_space", "stability",
        "forking", "independence_relation", "rank"
    };
