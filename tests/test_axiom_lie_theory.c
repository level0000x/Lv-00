...
#define AXIOM_PKG_PATH "axiom_packages/lie_theory.lvz"
#define SAVE_TEST_PATH "axiom_packages/lie_theory_test_save.lvz"
...
static void test_load_from_file(void)
{
    ...
    TEST_ASSERT(pkg->name != NULL && strcmp(pkg->name, "lie_theory") == 0,
        "package name should be 'lie_theory'");
...
static void test_templates(void)
{
    ...
    TEST_ASSERT(pkg->template_count == EXPECTED_TEMPLATE_COUNT,
        "should have 70 constraint templates");
...
static void test_logical_framework(void)
{
    ...
    TEST_ASSERT(pkg->bottom_geometry != NULL &&
                strcmp(pkg->bottom_geometry,
                       "lie_group_smooth_manifold_with_lie_algebra_tangent_space") == 0,
...
static void test_external_refs(void)
{
    ...
    struct {
        ...
        { "lie_algebra_isomorphism_problem",
          "https://en.wikipedia.org/wiki/Group_isomorphism_problem" },
        { "lie_group_isomorphism_problem",
          "https://en.wikipedia.org/wiki/Lie_group" },
        { "nilpotency_testing_infinite_dimensional",
          "https://en.wikipedia.org/wiki/Word_problem_for_groups" },
        { "solvable_quotient_computation",
          "https://en.wikipedia.org/wiki/Solvable_group" },
        { "lie_algebra_word_problem",
          "https://en.wikipedia.org/wiki/Word_problem_for_groups" },
        { "representation_equivalence_problem",
          "https://en.wikipedia.org/wiki/Representation_theory" },
        { "invariant_subspace_lattice",
...
static void test_key_axioms_present(void)
{
    ...
    TEST_ASSERT(axiom_package_get_template(pkg, "jacobi_identity") != NULL,
        "Jacobi identity should exist");

    /* Core Lie group axioms */
    TEST_ASSERT(axiom_package_get_template(pkg, "lie_group_structure") != NULL,
        "Lie group structure should exist");
    TEST_ASSERT(axiom_package_get_template(pkg, "lie_group_smooth_manifold") != NULL,
        "smooth manifold should exist");
    TEST_ASSERT(axiom_package_get_template(pkg, "exponential_map") != NULL,
        "exponential map should exist");
    ...
    /* Structure theory */
    TEST_ASSERT(axiom_package_get_template(pkg, "killing_form") != NULL,
        "Killing form should exist");
    TEST_ASSERT(axiom_package_get_template(pkg, "root_system") != NULL,
        "root system should exist");
    TEST_ASSERT(axiom_package_get_template(pkg, "levi_decomposition") != NULL,
        "Levi decomposition should exist");
