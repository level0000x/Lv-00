...
#define AXIOM_PKG_PATH "axiom_packages/field_theory.lvz"
#define SAVE_TEST_PATH "axiom_packages/field_theory_test_save.lvz"
...
{
    printf("Test 1: Load field_theory.lvz from file...\n");
    ...
    TEST_ASSERT(pkg->name != NULL && strcmp(pkg->name, "field_theory") == 0,
        "package name should be 'field_theory'");
...
static void test_templates(void)
{
    ...
    TEST_ASSERT(pkg->template_count == EXPECTED_TEMPLATE_COUNT,
        "should have 37 constraint templates");
...
static void test_logical_framework(void)
{
    ...
    TEST_ASSERT(strcmp(pkg->bottom_geometry, "field_theory_abstract") == 0,
        "bottom_geometry should be 'field_theory_abstract'");
...
static void test_save_load_roundtrip(void)
{
    ...
    TEST_ASSERT(strcmp(pkg2->name, "field_theory") == 0,
...
/* ──────────────────────────────────────────────
 * Test 10: Key field theory template checks
 * ────────────────────────────────────────────── */
static void test_key_templates(void)
{
    ...
    const char *core_axioms[] = {
        "addition_associativity", "addition_commutativity",
        "additive_identity", "additive_inverse",
        "multiplication_associativity", "multiplicative_identity",
        "multiplication_commutativity", "distributivity",
        "multiplicative_inverse", "zero_not_one"
    };
