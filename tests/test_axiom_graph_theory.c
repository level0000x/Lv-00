...
#define AXIOM_PKG_PATH "axiom_packages/graph_theory.lvz"
#define SAVE_TEST_PATH "axiom_packages/graph_theory_test_save.lvz"
...
static void test_load_from_file(void)
{
    ...
    TEST_ASSERT(pkg->name != NULL && strcmp(pkg->name, "graph_theory") == 0,
        "package name should be 'graph_theory'");
...
static void test_templates(void)
{
    ...
    struct {
        ...
        /* Group I: Core Graph Definition (3) */
        { "vertex_set",                 0 },
        { "edge_set",                   2 },
        { "incidence",                  1 },
...
static void test_logical_framework(void)
{
    ...
    TEST_ASSERT(pkg->bottom_geometry != NULL &&
        strcmp(pkg->bottom_geometry, "graph_incidence_structure") == 0,
        "bottom_geometry should be 'graph_incidence_structure'");
    TEST_ASSERT(pkg->negation_encoding != NULL &&
        strcmp(pkg->negation_encoding, "classical_edge_complement") == 0,
...
static void test_content_hash(void)
{
    ...
    TEST_ASSERT(strcmp(hash1, hash2) == 0,
        "deterministic: same content should produce same hash");
...
static void test_roundtrip_save_load(void)
{
    ...
    TEST_ASSERT(save_status == AXIOM_SAVE_OK,
        "axiom_package_save should succeed");
...
static void test_external_refs(void)
{
    ...
    for (int i = 0; i < pkg->unconstructible_count; i++) {
        ...
        TEST_ASSERT(uc->external_ref != NULL,
            "external_ref should not be NULL");
        TEST_ASSERT(strncmp(uc->external_ref, "https://", 8) == 0,
...
static void test_unconstructible_dependencies(void)
{
    ...
    TEST_ASSERT(uc->dependency_count >= 3,
        "graph_3_coloring should have at least 3 dependencies");
    ...
    TEST_ASSERT(uc->dependency_count >= 3,
        "hamiltonian_cycle should have at least 3 dependencies");
    ...
    TEST_ASSERT(uc->dependency_count >= 3,
        "maximum_clique should have at least 3 dependencies");
    ...
    TEST_ASSERT(uc->dependency_count >= 3,
        "feedback_vertex_set should have at least 3 dependencies");
