...
#define AXIOM_PKG_PATH "axiom_packages/peano_arithmetic.lvz"
#define SAVE_TEST_PATH "axiom_packages/peano_arithmetic_test_save.lvz"
...
static void test_logical_framework(void)
{
    ...
    TEST_ASSERT(pkg->bottom_geometry != NULL &&
                strcmp(pkg->bottom_geometry, "peano_arithmetic_discrete") == 0,
        "bottom_geometry should be 'peano_arithmetic_discrete'");
    printf("  bottom_geometry: %s\n", pkg->bottom_geometry);

    TEST_ASSERT(pkg->negation_encoding != NULL &&
                strcmp(pkg->negation_encoding, "classical_first_order_logic") == 0,
...
static void test_external_refs(void)
{
    ...
    struct {
        ...
        { "consistency_of_PA",
          "https://en.wikipedia.org/wiki/G%C3%B6del%27s_second_incompleteness" },
        { "goodstein_theorem",
          "https://en.wikipedia.org/wiki/Goodstein%27s_theorem" },
        { "paris_harrington_principle",
          "https://en.wikipedia.org/wiki/Paris%E2%80%93Harrington_theorem" },
        { "kirby_paris_hydra",
          "https://en.wikipedia.org/wiki/Hydra_game" },
        { "truth_predicate_for_PA",
          "https://en.wikipedia.org/wiki/Tarski%27s_undefinability_theorem" },
        { "halting_problem_for_PA",
          "https://en.wikipedia.org/wiki/Halting_problem" },
        { "epsilon_0_consistency",
          "https://en.wikipedia.org/wiki/Epsilon_numbers" },
    };
...
static void test_template_categories(void)
{
    ...
    const char *category_templates[] = {
        ...
        "add_zero_left", "add_successor_right", "mul_zero", "mul_successor_right",
        /* Induction */
        "induction_schema", "strong_induction",
        /* Order */
        "less_than_definition", "less_than_irreflexive", "less_than_transitive",
        /* Arithmetic consequences */
        "addition_commutative", "multiplication_commutative",
        "distributivity_left", "no_zero_divisors",
        /* Exponentiation */
        "exp_zero", "exp_successor", "exp_power_law",
        /* Divisibility */
        "division_algorithm", "euclidean_gcd", "bezout_identity",
        /* Primality */
        "prime_definition", "unique_prime_factorization", "euclid_lemma",
        /* Constructors */
        "successor", "add", "multiply", "exponentiate",
        "factorial", "gcd", "lcm", "primality_test",
        /* Gödel encoding */
        "beta_function_encode", "beta_function_decode",
    ...
    for (int i = 0; i < cat_total; i++) {
        ConstraintTemplate *tmpl =
            axiom_package_get_template(pkg, category_templates[i]);
        if (tmpl) cat_found++;
    }

    TEST_ASSERT(cat_found == cat_total,
        "all category templates should be found");
