...
static void test_save_load_roundtrip(void)
{
    ...
    TEST_ASSERT(strcmp(pkg2->name, "category_theory") == 0,
...
static void test_key_templates(void)
{
    ...
    const char *minimal_category[] = {
        "object", "morphism", "composability", "composition",
        "identity_morphism", "associativity", "left_identity", "right_identity"
    };
    ...
    const char *minimal_functor[] = {
        "functor_object_map", "functor_morphism_map",
        "functor_preserves_composition", "functor_preserves_identity"
    };
