...
static void test_logical_framework(void)
{
    ...
    TEST_ASSERT(strstr(pkg->bottom_geometry, "identity_type") != NULL ||
                strstr(pkg->bottom_geometry, "homotopy") != NULL,
...
static void test_save_load_roundtrip(void)
{
    ...
    TEST_ASSERT(strcmp(pkg2->name, "homotopy_type_theory") == 0,
...
static void test_key_templates(void)
{
    ...
    /* Identity types core */
    const char *identity_core[] = {
        "identity_type_path", "path_induction", "refl_identity"
    };
    ...
    /* Equivalence core */
    const char *equiv_core[] = {
        "homotopy_equivalence", "quasi_inverse", "ua_univalence"
    };
