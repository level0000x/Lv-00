...
#define AXIOM_PKG_PATH "axiom_packages/homotopy_type_theory.lvz"
#define SAVE_TEST_PATH "axiom_packages/homotopy_type_theory_test_save.lvz"
...
static void test_load_from_file(void) {
    printf("Test 1: Load homotopy_type_theory.lvz from file...\n");
    ...
    TEST_ASSERT(pkg->name != NULL && strcmp(pkg->name, "homotopy_type_theory") == 0,
                "package name should be 'homotopy_type_theory'");
...
static void test_templates(void) {
    ...
    TEST_ASSERT(pkg->template_count == EXPECTED_TEMPLATE_COUNT, "should have 37 constraint templates");
...
static void test_unconstructibles(void) {
    ...
    struct {
        ...
        {"univalence_proof_checker", "undecidable", 4, true},   {"canonicity_in_hoq", "open_problem", 5, true},
        {"set_membership_hott", "open_problem", 3, true},       {"higher_inductive_coherence", "undecidable", 4, true},
        {"univalence_extensionality", "open_problem", 3, true}, {"constructive_univalence", "open_problem", 4, true},
    };
...
static void test_save_load_roundtrip(void) {
    ...
    TEST_ASSERT(strcmp(pkg2->name, "homotopy_type_theory") == 0, "reloaded package should have same name");
...
/* ──────────────────────────────────────────────
 * Test 10: Key HoTT template checks
 * ────────────────────────────────────────────── */
