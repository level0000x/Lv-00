...
#define AXIOM_PKG_PATH "axiom_packages/homological_algebra.lvz"
#define SAVE_TEST_PATH "axiom_packages/homological_algebra_test_save.lvz"
...
static void test_templates(void)
{
    ...
    TEST_ASSERT(pkg->template_count == EXPECTED_TEMPLATE_COUNT,
        "should have 36 constraint templates");
...
static void test_save_load_roundtrip(void)
{
    ...
    TEST_ASSERT(strcmp(pkg2->name, "homological_algebra") == 0,
...
static void test_key_templates(void)
{
    ...
    const char *abelian_core[] = {
        "zero_object", "biproduct", "kernel",
    ...
    const char *chain_basics[] = {
        "chain_complex", "cochain_complex", "chain_map",
    ...
    /* Derived functors */
    const char *derived_functors[] = {
        "left_derived_functor", "right_derived_functor",
        "tor_functor", "ext_functor", "spectral_sequence"
    };
