...
static void test_load_from_file(void)
{
    ...
    TEST_ASSERT(pkg->name != NULL && strcmp(pkg->name, "metric_space") == 0,
        "package name should be 'metric_space'");
...
static void test_templates(void)
{
    ...
    const char *expected_templates[] = {
        ...
        "compact_equals_complete_totally_bounded",
    ...
    TEST_ASSERT(t && t->param_count == 1,
        "metric_open_set should have 1 param");
    t = axiom_package_get_template(pkg, "closure");
    TEST_ASSERT(t && t->param_count == 1,
        "closure should have 1 param");
    t = axiom_package_get_template(pkg, "boundary");
    TEST_ASSERT(t && t->param_count == 1,
        "boundary should have 1 param");
    ...
    TEST_ASSERT(t && t->param_count == 2,
        "product_metric_linf should have 2 params");
    t = axiom_package_get_template(pkg, "product_metric_l2");
    TEST_ASSERT(t && t->param_count == 2,
        "product_metric_l2 should have 2 params");
    t = axiom_package_get_template(pkg, "product_metric_l1");
    TEST_ASSERT(t && t->param_count == 2,
        "product_metric_l1 should have 2 params");
    t = axiom_package_get_template(pkg, "quotient_metric");
    TEST_ASSERT(t && t->param_count == 2,
        "quotient_metric should have 2 params");
...
static void test_unconstructible_problems(void)
{
    ...
    struct {
        ...
        { "isometric_embedding_into_l2",
          "gram_matrix_positive_semi_definiteness", 3, true },
        { "separable_metric_space_classification",
          "uncountable_isometry_classes", 3, true },
        { "urysohn_universal_space_existence",
          "requires_axiom_of_choice", 3, true },
        { "finite_metric_space_isometry",
          "graph_isomorphism", 4, true },
        { "finite_metric_embedding_into_Rn",
          "NP_hard_optimization", 3, true },
        { "hausdorff_distance_computability",
          "non_computable_in_computable_analysis", 3, true },
        { "baire_category_without_choice",
          "requires_dependent_choice", 3, true },
        { "general_metrizability",
          "nagata_smirnov_conditions", 3, true },
    };
...
static void test_logical_framework(void)
{
    ...
    TEST_ASSERT(pkg->bottom_geometry != NULL &&
                strcmp(pkg->bottom_geometry, "metric_space_general") == 0,
        "bottom_geometry should be 'metric_space_general'");
    printf("  bottom_geometry: %s\n", pkg->bottom_geometry);

    TEST_ASSERT(pkg->negation_encoding != NULL &&
                strcmp(pkg->negation_encoding, "classical_distance_negation") == 0,
