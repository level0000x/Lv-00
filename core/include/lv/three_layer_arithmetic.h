 ...
 * 审计结果通过 lv_float_audit_report() 导出。
 *
 * 适用场景：渐进式移除浮点依赖的迁移阶段。
 */
 ...
 * @note 当 lv_NO_FLOAT=1 时，使用此宏将产生编译错误。
 */
#ifndef lv_DOUBLE_TO_RATIONAL_NOTE
#define lv_DOUBLE_TO_RATIONAL_NOTE(x, note) /* 标记有注释的转换 */
#endif
...
#endif /* lv_THREE_LAYER_ARITHMETIC_H */
