 ...
 * @date 2026-05-24
 */
#ifndef lv_ALGEBRA_MODE_H
#define lv_ALGEBRA_MODE_H
#include <stdbool.h>
#include <stddef.h>
#include <stdint.h>
#ifdef __cplusplus
 ...
 *
 * 使用方法：
 *   lvSelector *sel = algebra_selector_create(SELECTOR_BY_DIRECTION, ">Z");
 *   // 选择所有法向朝 +Z 的面
 */
 ...
 * @return 新创建的 lvSelector*，失败返回 NULL
 */
