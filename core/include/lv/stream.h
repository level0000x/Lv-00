 ...
 *
 * 使用方式:
 lv_PUBLIC_API *   1. 创建上下文: StreamContext *ctx = stream_context_create();
 ...
 */
lv_PUBLIC_API StreamContext *stream_context_create(void);
 ...
 */
lv_PUBLIC_API void stream_context_destroy(StreamContext *ctx);
 ...
 */
lv_PUBLIC_API bool stream_register_callback(StreamContext *ctx, StreamCallback callback, void *user_data);
 ...
 */
lv_PUBLIC_API bool stream_unregister_callback(StreamContext *ctx, StreamCallback callback);
 ...
 * @return true 成功，false 未找到或 ctx 为 NULL
 */
lv_PUBLIC_API bool stream_unregister_callback_by_id(StreamContext *ctx, int callback_id);
 ...
 */
lv_PUBLIC_API bool stream_set_callback_filter(StreamContext *ctx, int callback_id, uint64_t filter_mask);
 ...
 */
lv_PUBLIC_API uint64_t stream_get_callback_filter(StreamContext *ctx, int callback_id);
 ...
 */
lv_PUBLIC_API void stream_set_emit_mode(StreamContext *ctx, StreamEmitMode mode, long throttle_ms);
 ...
 * @return 当前发射模式
 */
lv_PUBLIC_API StreamEmitMode stream_get_emit_mode(const StreamContext *ctx);
 ...
 * @param event  事件数据
 */
lv_PUBLIC_API void stream_emit(StreamContext *ctx, const StreamEvent *event);
 ...
 * @param step_number 步骤编号
 */
lv_PUBLIC_API void stream_emit_merge(StreamContext *ctx, int from_id, int to_id, int step_number);
 ...
 * @param step_number 步骤编号
 */
lv_PUBLIC_API void stream_emit_error(StreamContext *ctx, const char *description, int step_number);
 ...
 * @param step_number 步骤编号
 */
lv_PUBLIC_API void stream_emit_warning(StreamContext *ctx, const char *description, int step_number);
 ...
 * @param step_number 步骤编号
 */
lv_PUBLIC_API void stream_emit_info(StreamContext *ctx, const char *description, int step_number);
 ...
 * @param step_number  步骤编号
 */
lv_PUBLIC_API void stream_emit_preset_register(StreamContext *ctx, const char *name, bool success, int step_number);
 ...
 */
lv_PUBLIC_API bool stream_set_async_mode(StreamContext *ctx, bool enabled, int capacity);
 ...
 * @param ctx  流式上下文
 */
lv_PUBLIC_API void stream_flush(StreamContext *ctx);
 ...
 */
lv_PUBLIC_API int stream_pending_count(StreamContext *ctx);
 ...
 * @return 被清除的事件数
 */
lv_PUBLIC_API int stream_clear_buffer(StreamContext *ctx);
 ...
 * @return 缓冲区事件数
 */
lv_PUBLIC_API int stream_buffer_size(const StreamContext *ctx);
 ...
 */
lv_PUBLIC_API int stream_event_to_json(const StreamEvent *event, char *buffer, size_t size);
 ...
 * @return 写入的字节数（不含终止符），缓冲区不足时返回所需大小
 */
lv_PUBLIC_API int stream_event_to_jsonrpc(const StreamEvent *event, char *buffer, size_t size);
 ...
 * @param ctx  流式上下文
 */
lv_PUBLIC_API void stream_reset_stats(StreamContext *ctx);
 ...
 * @return 发射次数
 */
lv_PUBLIC_API int64_t stream_get_event_count(const StreamContext *ctx, StreamEventType type);
 ...
 * @return 总发射次数
 */
lv_PUBLIC_API int64_t stream_get_total_event_count(StreamContext *ctx);
 ...
 * @return 丢弃的事件数
 */
lv_PUBLIC_API long stream_get_dropped_count(const StreamContext *ctx);
 ...
 * @return 毫秒级时间戳
 */
lv_PUBLIC_API long stream_timestamp_ms(void);
 ...
 */
lv_PUBLIC_API const char *stream_event_type_name(StreamEventType type);
 ...
 */
lv_PUBLIC_API const char *stream_event_type_id(StreamEventType type);
 ...
 * @return CSS 颜色名称字符串
 */
lv_PUBLIC_API const char *stream_event_color(StreamEventType type);
 ...
 */
lv_PUBLIC_API uint64_t stream_parse_filter_mask(const char *str);
 ...
 */
lv_PUBLIC_API const StreamEvent *stream_lazy_next(StreamContext *ctx);
 ...
 * @return 实际拉取并处理的事件数
 */
lv_PUBLIC_API int stream_lazy_drain(StreamContext *ctx, StreamCallback callback, void *user_data, int max_count);
 ...
 * @return 待处理事件数
 */
lv_PUBLIC_API int stream_lazy_pending(const StreamContext *ctx);
 ...
 */
lv_PUBLIC_API void stream_set_lazy_threshold(StreamContext *ctx, int threshold);
