...
bool lv_test_register(const char *suite_name, const char *test_name,
                        lvTestFunc func);
...
bool lv_test_register_suite_fixture(const char *suite_name,
                                      lvTestSetupFunc setup,
                                      lvTestTeardownFunc teardown);
bool lv_test_register_data_driven(const char *suite_name, const char *test_name,
                                    lvTestFunc func,
                                    lvTestDataGenerator generator,
                                    int data_count);
bool lv_test_register_tag(const char *suite_name, const char *test_name,
                            const char *tag);
...
bool lv_benchmark_register(const char *name, lvBenchmarkFunc func,
                             uint64_t iterations);
