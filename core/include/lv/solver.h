 ...
 */
lv_PUBLIC_API void solver_set_stream_context(StreamContext *ctx);
 ...
 * @return 求解器状态
 */
lv_PUBLIC_API SolverStatus analyze_out_of_scope(const ConstraintGraph *graph, int var_id, char **suggestion);
 ...
 */
lv_PUBLIC_API int count_degrees_of_freedom(const ConstraintGraph *graph, int **out_free_var_ids);

lv_PUBLIC_API bool check_conflict_equations(const ConstraintGraph *graph);
 ...
 */
lv_PUBLIC_API void groebner_result_destroy(GroebnerResult *result);
 ...
 */
lv_PUBLIC_API int solver_extract_equations_full(const ConstraintGraph *graph, EquationSystem *out_system);
 ...
 */
lv_PUBLIC_API SolverStatus groebner_basis_compute(EquationSystem *system);
 ...
 */
lv_PUBLIC_API EquationSystem *equation_system_create(void);

/**
 * @brief 销毁方程系统并释放所有资源
 * @param[in,out] sys 要销毁的方程系统
 */
lv_PUBLIC_API void equation_system_destroy(EquationSystem *sys);
 ...
 * @return 方程数量
 */
lv_PUBLIC_API int equation_system_count(const EquationSystem *sys);
 ...
 */
lv_PUBLIC_API const mpz_poly_t *equation_system_get_poly(const EquationSystem *sys, int index);
 ...
 */
lv_PUBLIC_API int equation_system_get_var_id(const EquationSystem *sys, int index);
 ...
 */
lv_PUBLIC_API int equation_system_get_coord_index(const EquationSystem *sys, int index);
 ...
 *   严禁对上述字段调用 free() 或 lv_free()，否则会导致 double-free。
 */
 ...
 */
lv_PUBLIC_API SolverFeedback *solver_feedback_create(SolverFeedbackType type, const char *message);

/**
 * @brief 销毁求解器反馈
 */
lv_PUBLIC_API void solver_feedback_destroy(SolverFeedback *feedback);
 ...
 */
lv_PUBLIC_API SolverFeedback *solver_feedback_solve(ConstraintGraph *graph, const int *dirty_vars, int dirty_count);
 ...
 * @return 求解器状态
 */
lv_PUBLIC_API SolverStatus solver_sparse_solve(ConstraintGraph *graph, GroebnerResult **out_result);
