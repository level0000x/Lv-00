...
#ifndef lv_ADAPTIVE_PRUNING_H
#define lv_ADAPTIVE_PRUNING_H
 ...
 * @brief 自适应剪枝器
 */
struct lvAdaptivePruner {
    lvAdaptiveConfig config;          /**< 自适应配置 */
    lvProblemComplexity complexity;   /**< 问题复杂度 */
    lvSearchHeuristics heuristics;    /**< 搜索启发式信息 */
...
typedef struct lvAdaptivePruner lvAdaptivePruner;
