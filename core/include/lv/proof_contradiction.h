...
lv_PUBLIC_API int lv_assumption_stack_push(lvAssumptionStack *stack, lvProofScopeId scope_id, lvAssumptionType type,
                                           Proposition *prop);
...
lv_PUBLIC_API int lv_assumption_stack_get_by_scope(lvAssumptionStack *stack, lvProofScopeId scope_id,
                                                   lvAssumptionEntry **out, int max_out);
lv_PUBLIC_API lvContradictionClosure *lv_contradiction_closure_create(lvProofScopeId scope_id, lvContradictionType type,
                                                                      Proposition *prop);
...
lv_PUBLIC_API bool lv_contradiction_propagation_detect(lvProofScopeId scope, lvContradictionClosure **closures,
                                                       int closure_count);
lv_PUBLIC_API lvContradictionBreakpoint *lv_contradiction_breakpoint_create(lvBreakpointType type,
                                                                            lvProofScopeId scope_id, int step_id,
                                                                            const char *description);
lv_PUBLIC_API void lv_contradiction_breakpoint_destroy(lvContradictionBreakpoint *bp);
lv_PUBLIC_API int lv_contradiction_detect_breakpoints(lvProofNavigatorEx *navigator,
                                                      lvContradictionBreakpoint **breakpoints, int max_breakpoints);
...
lv_PUBLIC_API bool lv_proof_end_contradiction(lvProofNavigatorEx *navigator, lvProofScopeId scope_id,
