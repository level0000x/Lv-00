 ...
 *  前向声明
 * ================================================================ */
typedef struct lvWidgetLayout lvWidgetLayout;
typedef struct lvGoalDisplay lvGoalDisplay;
typedef struct lvHypothesisEntry lvHypothesisEntry;
typedef struct lvProofStepHighlight lvProofStepHighlight;
