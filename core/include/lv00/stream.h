 ...
 * @param step_number   步骤编号
 */
LV00_PUBLIC_API void stream_emit_constraint_event(StreamContext *ctx, StreamEventType type, int constraint_id, const char *description,
                                  int step_number);
 ...
 */
LV00_PUBLIC_API void stream_emit_progress(StreamContext *ctx, double progress, const char *description, int step_number,
                          int total_steps);
 ...
 * @param step_number   步骤编号
 */
LV00_PUBLIC_API void stream_emit_numeric(StreamContext *ctx, StreamEventType type, double numeric_value, const char *description,
                         int step_number);
 ...
 * @param step_number 步骤编号
 */
LV00_PUBLIC_API void stream_emit_graph_snapshot(StreamContext *ctx, StreamEventType type, const char *graph_json,
 ...
 * @param step_number 步骤编号
 */
LV00_PUBLIC_API void stream_emit_variable_resolved(StreamContext *ctx, int var_id, double value, const char *description,
                                   int step_number);
 ...
 * @param step_number  步骤编号
 */
LV00_PUBLIC_API void stream_emit_preset_validate(StreamContext *ctx, const char *name, bool is_valid, const char *detail,
                                 int step_number);
