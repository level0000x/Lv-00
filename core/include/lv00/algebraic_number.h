 ...
 *   - 内存安全：使用 lv00_malloc/lv00_free 管理内存
 *
...
#ifndef LV00_ALGEBRAIC_NUMBER_H
#define LV00_ALGEBRAIC_NUMBER_H
 ...
 * 对于精确比较，建议使用 alg_quadratic_cmp_exact。
 *
 * @param[in] x 二次代数数
 * @param[in] y 二次代数数
