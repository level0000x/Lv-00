...
LV00_PUBLIC_API AxiomPackage *axiom_package_create(const char *name, const char *version);
LV00_PUBLIC_API void axiom_package_destroy(AxiomPackage *pkg);
...
/* 获取最后一次加载错误的详细信息 */
LV00_PUBLIC_API const char *axiom_package_get_last_error(void);

LV00_PUBLIC_API AxiomLoadStatus axiom_package_load(AxiomPackage *pkg, const char *filepath);
LV00_PUBLIC_API AxiomSaveStatus axiom_package_save(const AxiomPackage *pkg, const char *filepath);
 ...
 * @return 测试结果
 */
LV00_PUBLIC_API TemplateTestResult axiom_template_run_tests(AxiomPackage *pkg, const char *template_name,
 ...
 * @brief 释放测试结果
 */
LV00_PUBLIC_API void axiom_template_test_result_destroy(TemplateTestResult *result);
 ...
 * @brief 在缓存中查找匹配的展开图
 */
LV00_PUBLIC_API ConstraintGraph *axiom_package_lookup_expansion_cache(AxiomPackage *pkg, const char *template_name,
 ...
 * @brief 清空模板展开缓存
 */
LV00_PUBLIC_API void axiom_package_clear_expansion_cache(AxiomPackage *pkg);
 ...
 */
LV00_PUBLIC_API int axiom_package_register_dependency_ref(AxiomPackage *pkg, const char *ref_id, const char *content_hash,
 ...
 */
LV00_PUBLIC_API int axiom_package_validate_dependencies_with_hashes(AxiomPackage *pkg, DependencyRef **invalidated_refs,
 ...
 * @return 被降级的节点数量
 */
LV00_PUBLIC_API int axiom_package_auto_degrade_invalidated(AxiomPackage *pkg, ConstraintGraph *graph);
