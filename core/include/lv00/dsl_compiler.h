...
#endif /* LV00_DSL_COMPILER_H */
/* ========================================================================
 * 模块名称：DSL 编译器 (/* ========================================================================
 * 模块名称：DSL 编译器 (dsl_compiler) - v3.5.0 增强版
 * 功能概述：借鉴 Ganja.js 的 AST 转译和 GCLC 几何构造语言，提供从
 *          DSL 源码到约束图的完整编译管线。包含词法分析、语法解析、
 *          AST 构建、中间表示（IR）生成和约束图填充五个阶段。
 *          支持多种目标平台代码生成。
