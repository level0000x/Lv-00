...
int  smtencode_constraint_graph_to_smtlib2(const ConstraintGraph *graph, SMTLogic logic,
                                            bool produce_unsat_cores, char *out, size_t out_len);
...
int  smtsolver_check_constraint_satisfied(SMTSolver *solver, const ConstraintGraph *graph,
                                           SMTSolverResult *out_result);
...
SMTSatResult smt_external_solver_check(SMTSolver *solver, const char *smtlib2,
                                        const char *solver_cmd, int timeout_ms,
