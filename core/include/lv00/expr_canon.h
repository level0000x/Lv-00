 ...
 * @return 是否成功
 */
bool lv00_expr_canonical_add_term(Lv00ExprCanonical *expr,
                                   const Lv00Rational *coeff,
                                   const int *exponents);
 ...
 */
Lv00ExprCanonical *lv00_expr_canonical_add(const Lv00ExprCanonical *a,
                                            const Lv00ExprCanonical *b);
 ...
 * @return a - b，失败返回 NULL
 */
Lv00ExprCanonical *lv00_expr_canonical_sub(const Lv00ExprCanonical *a,
                                            const Lv00ExprCanonical *b);
 ...
 * @return a * b，失败返回 NULL
 */
Lv00ExprCanonical *lv00_expr_canonical_mul(const Lv00ExprCanonical *a,
                                            const Lv00ExprCanonical *b);
 ...
 */
Lv00ExprCanonical *lv00_expr_canonical_scale(const Lv00ExprCanonical *a,
                                              const Lv00Rational *coeff);
 ...
 * @return 是否相等
 */
bool lv00_expr_canonical_equal(const Lv00ExprCanonical *a,
                                const Lv00ExprCanonical *b);
 ...
 */
Lv00ExprCanonical *lv00_expr_canonical_from_string(const char *str,
