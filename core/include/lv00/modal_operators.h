 ...
 *
 * 使用示例：
 LV00_PUBLIC_API *   Lv00ModalFrame *frame = lv00_modal_frame_create_geometric_default();
 LV00_PUBLIC_API *   Lv00ModalFormula *f = lv00_modal_assert_point_must_on_line(frame, pt, ln);
 *   Lv00ModalEvalResult result;
 LV00_PUBLIC_API *   lv00_modal_evaluate(frame, f, 1, &result);
 *
 * @version 1.0.0
 * ======================================================================== */
 ...
 */
LV00_PUBLIC_API Lv00ModalWorld *lv00_modal_world_create(int id, const char *world_name, ConstraintGraph *configuration);
 ...
 */
LV00_PUBLIC_API void lv00_modal_world_destroy(Lv00ModalWorld *world);
 ...
 */
LV00_PUBLIC_API bool lv00_modal_world_assert(Lv00ModalWorld *world, Proposition *prop);
 ...
 * @return 真值（三值逻辑）
 */
LV00_PUBLIC_API Lv00TruthValue lv00_modal_world_holds(const Lv00ModalWorld *world, const Proposition *prop);
 ...
 */
LV00_PUBLIC_API Lv00ModalFrame *lv00_modal_frame_create(void);
 ...
 */
LV00_PUBLIC_API void lv00_modal_frame_destroy(Lv00ModalFrame *frame);
 ...
 * @return true 成功，false 失败
 */
LV00_PUBLIC_API bool lv00_modal_frame_add_world(Lv00ModalFrame *frame, Lv00ModalWorld *world);
 ...
 * @return true 成功，false 失败
 */
LV00_PUBLIC_API bool lv00_modal_frame_set_reachability(Lv00ModalFrame *frame, int from_world_id, int to_world_id,
 ...
 */
LV00_PUBLIC_API bool lv00_modal_frame_is_reachable(const Lv00ModalFrame *frame, int from_world_id, int to_world_id);
 ...
 * @return true 成功，false 失败
 */
LV00_PUBLIC_API bool lv00_modal_frame_get_reachable_worlds(const Lv00ModalFrame *frame, int world_id,
 ...
 */
LV00_PUBLIC_API Lv00ModalFormula *lv00_modal_formula_create(Lv00ModalOperator op, Proposition *inner_prop);
 ...
 * @return 新分配的模态公式，失败返回 NULL
 */
LV00_PUBLIC_API Lv00ModalFormula *lv00_modal_formula_create_nested(Lv00ModalOperator op, Lv00ModalFormula *sub);
 ...
 */
LV00_PUBLIC_API void lv00_modal_formula_destroy(Lv00ModalFormula *formula);
 ...
 * @return 0 成功，-1 参数错误
 */
LV00_PUBLIC_API int lv00_modal_evaluate(const Lv00ModalFrame *frame, const Lv00ModalFormula *formula,
 ...
 * @return 真值
 */
LV00_PUBLIC_API Lv00TruthValue lv00_modal_check_validity(const Lv00ModalFrame *frame, const Lv00ModalFormula *formula);
 ...
 */
LV00_PUBLIC_API Lv00ModalFormula *lv00_modal_possible_to_necessary_not(const Lv00ModalFormula *formula);
 ...
 * @return 转换后的模态公式（新分配），失败返回 NULL
 */
LV00_PUBLIC_API Lv00ModalFormula *lv00_modal_necessary_to_not_possible(const Lv00ModalFormula *formula);
 ...
 * @return 新分配的框架，失败返回 NULL
 */
LV00_PUBLIC_API Lv00ModalFrame *lv00_modal_frame_create_geometric_default(void);
 ...
 * @return 新分配的模态公式，失败返回 NULL
 */
LV00_PUBLIC_API Lv00ModalFormula *lv00_modal_assert_point_must_on_line(Lv00ModalFrame *frame, int point_id, int line_id);
 ...
 * @return 新分配的模态公式，失败返回 NULL
 */
LV00_PUBLIC_API Lv00ModalFormula *lv00_modal_assert_point_can_on_line(Lv00ModalFrame *frame, int point_id, int line_id);
 ...
 * @param result 评估结果指针
 */
LV00_PUBLIC_API void lv00_modal_eval_result_destroy(Lv00ModalEvalResult *result);
 ...
 * @return 静态字符串（"□" / "◇"），请勿释放
 */
LV00_PUBLIC_API const char *lv00_modal_op_to_string(Lv00ModalOperator op);
 ...
 * @return 静态字符串，请勿释放
 */
LV00_PUBLIC_API const char *lv00_reachability_type_to_string(Lv00ReachabilityType type);
 ...
 */
LV00_PUBLIC_API char *lv00_modal_formula_to_string(const Lv00ModalFormula *formula);
