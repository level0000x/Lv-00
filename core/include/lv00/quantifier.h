 ...
 *
 * 使用示例：
 LV00_PUBLIC_API *   Lv00Domain *d = lv00_quant_domain_create_finite(1, elements, n);
 *   Lv00QuantifiedExpr *expr = lv00_quant_expr_create(
 *       1, LV00_FORALL, "p", var_id, d, body_prop);
 LV00_PUBLIC_API *   Lv00TruthValue tv = lv00_quant_expr_evaluate(expr);
 *
 * @version 1.1.0
 * ======================================================================== */
...
/* ============== 前向声明 ============== */
typedef struct Lv00QuantifiedExpr Lv00QuantifiedExpr;
typedef struct Lv00Domain Lv00Domain;
typedef struct Lv00QuantifiedResult Lv00QuantifiedResult;
 ...
 * @brief 量词枚举
 *
 * LV00_FORALL       : ∀  全称量词  "对所有...都成立"
 * LV00_EXISTS       : ∃  存在量词  "存在一个...使得..."
 * LV00_EXISTS_UNIQUE: ∃! 唯一存在  "存在唯一一个...使得..."
 */
typedef enum {
    LV00_FORALL        = 0,
    LV00_EXISTS        = 1,
    LV00_EXISTS_UNIQUE = 2
} Lv00Quantifier;
...
typedef enum {
    LV00_QUANT_OK,                 /**< 操作成功 */
    LV00_QUANT_DOMAIN_EMPTY,       /**< 域为空（∀ 为真，∃ 为伪） */
 ...
 * @brief 实例化结果
 */
struct Lv00QuantifiedResult {
    Lv00QuantResult status;         /**< 操作结果状态 */
    Lv00TruthValue truth_value;     /**< 量词表达式的真值 */
 ...
 */
LV00_PUBLIC_API Lv00Domain *lv00_quant_domain_create(int id, const char *domain_name);
 ...
 * @return 新分配的域，失败返回 NULL
 */
LV00_PUBLIC_API Lv00Domain *lv00_quant_domain_create_finite(int id, const int *elements, int count);
 ...
 */
LV00_PUBLIC_API bool lv00_quant_domain_add_element(Lv00Domain *domain, int element);
 ...
 * @return true 成功，false 失败
 */
LV00_PUBLIC_API bool lv00_quant_domain_add_elements(Lv00Domain *domain, const int *elements, int count);
 ...
 */
LV00_PUBLIC_API bool lv00_quant_domain_contains(const Lv00Domain *domain, int element);
 ...
 * @return 元素数量（-1 表示无限）
 */
LV00_PUBLIC_API int lv00_quant_domain_size(const Lv00Domain *domain);
 ...
 */
LV00_PUBLIC_API void lv00_quant_domain_destroy(Lv00Domain *domain);
 ...
 */
LV00_PUBLIC_API Lv00QuantifiedExpr *lv00_quant_expr_create(int id, Lv00Quantifier quantifier, const char *variable_name,
 ...
 */
LV00_PUBLIC_API void lv00_quant_expr_destroy(Lv00QuantifiedExpr *expr);

/**
 * @brief 评估量化表达式的真值（三值逻辑）
 *
 * 对有限域尝试完全评估；对无限域返回 LV00_UNKNOWN。
 *
 * @param expr 量化表达式
 * @return 三值真值
 */
LV00_PUBLIC_API Lv00TruthValue lv00_quant_expr_evaluate(Lv00QuantifiedExpr *expr);
 ...
 * @return 操作结果
 */
LV00_PUBLIC_API Lv00QuantResult lv00_quantifier_instantiate(const Lv00QuantifiedExpr *expr, int instance_id,
 ...
 * @return 操作结果
 */
LV00_PUBLIC_API Lv00QuantResult lv00_quantifier_generalize(const Lv00QuantifiedExpr *expr, Lv00QuantifiedResult *out_result);
 ...
 * @return 操作结果
 */
LV00_PUBLIC_API Lv00QuantResult lv00_quant_exists_introduce(Lv00QuantifiedExpr *expr, int witness_id,
                                            Lv00QuantifiedResult *out_result);
 ...
 * @return 操作结果
 */
LV00_PUBLIC_API Lv00QuantResult lv00_quant_exists_eliminate(const Lv00QuantifiedExpr *exists_expr,
 ...
 * @return 操作结果
 */
LV00_PUBLIC_API Lv00QuantResult lv00_quant_eliminate_forall_finite(const Lv00QuantifiedExpr *expr,
                                                    Lv00QuantifiedResult *out_result);
 ...
 * @return 操作结果
 */
LV00_PUBLIC_API Lv00QuantResult lv00_quant_eliminate_exists_finite(const Lv00QuantifiedExpr *expr,
                                                    Lv00QuantifiedResult *out_result);
 ...
 * @return 操作结果
 */
LV00_PUBLIC_API Lv00QuantResult lv00_quant_eliminate_exists_unique_finite(const Lv00QuantifiedExpr *expr,
                                                           Lv00QuantifiedResult *out_result);
 ...
 */
LV00_PUBLIC_API bool lv00_quant_is_eliminable(const Lv00QuantifiedExpr *expr);
 ...
 */
LV00_PUBLIC_API int lv00_quant_count_satisfying(const Lv00QuantifiedExpr *expr);
 ...
 */
LV00_PUBLIC_API void lv00_quant_result_destroy(Lv00QuantifiedResult *result);
 ...
 * @return 静态字符串（"∀" / "∃" / "∃!"），请勿释放
 */
LV00_PUBLIC_API const char *lv00_quant_to_string(Lv00Quantifier q);
 ...
 * @return 静态字符串，请勿释放
 */
LV00_PUBLIC_API const char *lv00_quant_result_to_string(Lv00QuantResult result);

#ifdef __cplusplus
}
#endif

#endif /* LV00_QUANTIFIER_H */
