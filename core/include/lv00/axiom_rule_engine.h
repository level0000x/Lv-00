...
typedef struct {
    ...
    Lv00RuleCondition *conditions; /**< 额外条件 */
...
struct Lv00Rule {
    /* 基本信息 */
    uint32_t id;                /**< 规则 ID */
    char name[LV00_RULE_NAME_MAX_LEN]; /**< 规则名称 */
    ...
    Lv00RulePremise premises[LV00_RULE_MAX_PREMISES]; /**< 前提 */
 ...
 * @brief 规则匹配结果
 */
struct Lv00RuleMatch {
    Lv00Rule *rule;             /**< 匹配的规则 */
    Lv00RuleVariable bindings[LV00_RULE_MAX_VARIABLES]; /**< 变量绑定 */
 ...
 * @brief 难度评估结果
 */
struct Lv00DifficultyAssessment {
