...
typedef enum {
    ...
    PRESET_TYPE_RING_HOMOMORPHISM, /**< 环同态 */
...
#define preset_blocks_register_algebraic(n, d, c, ic, oc) preset_blocks_register_by_category((n), (d), (c), (ic), (oc))
#define preset_blocks_register_logic(n, d, c, ic, oc) preset_blocks_register_by_category((n), (d), (c), (ic), (oc))
...
/* 群论运算 */
#ifndef PRESET_GROUP_CYCLIC_GENERATOR
