 ...
 */
LV00_PUBLIC_API GACodegenResult *ga_codegen_compile(const Lv00MultiVector *mv,
 ...
 */
LV00_PUBLIC_API void ga_codegen_result_destroy(GACodegenResult *result);
 ...
 * @return A new LaTeX string (caller owns, free with lv00_free_ptr)
 */
LV00_PUBLIC_API char *ga_render_latex(const Lv00MultiVector *mv);
 ...
 *
 * @param mv  Source multivector
 * @return A new DOT string (caller owns, free with lv00_free_ptr)
 */
LV00_PUBLIC_API char *ga_render_dot(const Lv00MultiVector *mv);
