...
LV00_PUBLIC_API Lv00ErrorCode lv00_add_node_result_to_error(AddNodeResult result);
/** @brief 将 AddConstraintResult 转换为 Lv00ErrorCode */
LV00_PUBLIC_API Lv00ErrorCode lv00_add_constraint_result_to_error(AddConstraintResult result);
/** @brief 将 RemoveNodeResult 转换为 Lv00ErrorCode */
LV00_PUBLIC_API Lv00ErrorCode lv00_remove_node_result_to_error(RemoveNodeResult result);
 ...
 * @return 操作结果状态码
 */
LV00_PUBLIC_API AddNodeResult graph_add_line_segment(ConstraintGraph *graph, int endpoint1_id, int endpoint2_id);
 ...
 * @return 操作结果状态码
 */
LV00_PUBLIC_API AddNodeResult graph_add_region(ConstraintGraph *graph, const int *boundary_segment_ids, int segment_count);
 ...
 * @return 操作结果状态码
 */
LV00_PUBLIC_API AddNodeResult graph_add_port(ConstraintGraph *graph, PortType type, int namespace_depth, int parent_block_id);
/**
 * @brief 向约束图添加函数块节点
 *
 * @param[in] graph             约束图
 ...
 *
 */
LV00_PUBLIC_API AddNodeResult graph_add_function_block(ConstraintGraph *graph, const int *internal_node_ids, int internal_count,
 ...
 */
LV00_PUBLIC_API int graph_get_last_added_node_id(const ConstraintGraph *graph);
 ...
 * @return 操作结果状态码
 */
LV00_PUBLIC_API AddConstraintResult graph_add_incidence(ConstraintGraph *graph, int point_id, int line_or_region_id);
 ...
 * @return 操作结果状态码
 */
LV00_PUBLIC_API AddConstraintResult graph_add_betweenness(ConstraintGraph *graph, int p1_id, int p2_id, int p3_id);
 ...
 * @return 操作结果状态码
 */
LV00_PUBLIC_API AddConstraintResult graph_add_intersection(ConstraintGraph *graph, int line1_id, int line2_id, int result_point_id);
 ...
 * @return 操作结果状态码
 */
LV00_PUBLIC_API AddConstraintResult graph_add_containment(ConstraintGraph *graph, int inner_id, int outer_id);
 ...
 * @return 操作结果状态码
 */
LV00_PUBLIC_API AddConstraintResult graph_add_connection(ConstraintGraph *graph, int src_port_id, int dst_port_id);
 ...
 * @return 操作结果状态码
 */
LV00_PUBLIC_API RemoveNodeResult graph_remove_node(ConstraintGraph *graph, int node_id);
 ...
 * @return 操作结果状态码
 */
LV00_PUBLIC_API RemoveConstraintResult graph_remove_constraint(ConstraintGraph *graph, int constraint_index);
 ...
 * @return 找到的约束数量
 */
LV00_PUBLIC_API int graph_find_constraints_involving(const ConstraintGraph *graph, int node_id, int *out_indices, int max_results);
 ...
 */
LV00_PUBLIC_API int graph_detect_redundancy(const ConstraintGraph *graph, ConstraintType type, const int *participants, int n_parts);
 ...
 * @return 节点数量
 */
LV00_PUBLIC_API int graph_get_node_count(const ConstraintGraph *graph);
 ...
 * @return 约束数量
 */
LV00_PUBLIC_API int graph_get_constraint_count(const ConstraintGraph *graph);
 ...
 */
LV00_PUBLIC_API GeomNode *graph_get_node_by_id(const ConstraintGraph *graph, int node_id);
 ...
 * @return 节点指针，未找到返回 NULL
 */
LV00_PUBLIC_API GeomNode *graph_get_node(const ConstraintGraph *graph, int node_id);
 ...
 */
LV00_PUBLIC_API Constraint *graph_get_constraint(const ConstraintGraph *graph, int constraint_id);
 ...
 */
LV00_PUBLIC_API void graph_node_index_insert(ConstraintGraph *graph, GeomNode *node);
 ...
 * @param[in] con   要注册的约束
 */
LV00_PUBLIC_API void graph_constraint_index_insert(ConstraintGraph *graph, Constraint *con);
 ...
 */
LV00_PUBLIC_API GeomNode *graph_add_node_with_id(ConstraintGraph *graph, int node_id, GeomType type, SymbolicCoord **coords,
                                 int coord_count);
 ...
 */
LV00_PUBLIC_API ConstraintGraph *graph_create(void);
 ...
 */
LV00_PUBLIC_API void graph_destroy(ConstraintGraph *graph);
 ...
 */
LV00_PUBLIC_API void graph_set_stream_context(StreamContext *ctx);
 ...
 */
LV00_PUBLIC_API CrossBoundaryConstraint *find_cross_boundary_constraints(ConstraintGraph *graph, const int *internal_node_ids,
 ...
 *         出错返回 NULL。
 */
LV00_PUBLIC_API int *graph_detect_redundant_constraints(const ConstraintGraph *graph, int *out_count);
 ...
 *         无冲突或出错返回 NULL。
 */
LV00_PUBLIC_API int **graph_detect_conflicts(const ConstraintGraph *graph, int *out_conflict_count, int **out_conflict_sizes);
 ...
 */
LV00_PUBLIC_API char *graph_serialize_to_json(const ConstraintGraph *graph);
 ...
 */
LV00_PUBLIC_API ConstraintGraph *graph_deserialize_from_json(const char *json);
 ...
 * @return JSON 字符串（调用者负责 free），失败返回 NULL
 */
LV00_PUBLIC_API char *graph_node_serialize_to_json(const GeomNode *node);
 ...
 * @return JSON 字符串（调用者负责 free），失败返回 NULL
 */
LV00_PUBLIC_API char *graph_constraint_serialize_to_json(const Constraint *constraint);
 ...
 */
LV00_PUBLIC_API const char *graph_get_serialize_error(const ConstraintGraph *graph);
 ...
 * @param ...   可变参数列表
 */
LV00_PUBLIC_API void graph_set_error(ConstraintGraph *graph, const char *fmt, ...);
 ...
 */
LV00_PUBLIC_API const char *graph_get_error(const ConstraintGraph *graph);
 ...
 * @return 默认配置
 */
LV00_PUBLIC_API DOTExportConfig dot_export_config_default(void);
 ...
 */
LV00_PUBLIC_API char *graph_export_dot(const ConstraintGraph *graph, const DOTExportConfig *config);
 ...
 */
LV00_PUBLIC_API int graph_export_dot_file(const ConstraintGraph *graph, const DOTExportConfig *config, const char *filepath);
 ...
 */
LV00_PUBLIC_API int graph_export_dot_to_svg(const ConstraintGraph *graph, const DOTExportConfig *config, const char *output_svg);
 ...
 */
LV00_PUBLIC_API void graph_mark_dirty(ConstraintGraph *graph);
 ...
 * @param graph 约束图（非 NULL）
 */
LV00_PUBLIC_API void graph_sync_nodes(ConstraintGraph *graph);
 ...
 */
LV00_PUBLIC_API int graph_deactivate_constraint(ConstraintGraph *graph, int constraint_id);
