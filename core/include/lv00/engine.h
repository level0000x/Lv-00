 ...
 */
LV00_PUBLIC_API LV00Engine *engine_create(void);
 ...
 */
LV00_PUBLIC_API void engine_destroy(LV00Engine *engine);
 ...
 */
LV00_PUBLIC_API ModuleLoadStatus engine_load_module(LV00Engine *engine, const char *filepath);
 ...
 */
LV00_PUBLIC_API AxiomLoadStatus engine_load_axiom_package(LV00Engine *engine, const char *filepath);
 ...
 */
LV00_PUBLIC_API int *engine_instantiate_function(LV00Engine *engine, int func_block_id, const int *arg_mappings, int arg_count,
                                 int *out_result_count);

LV00_PUBLIC_API UnifyStatus engine_unify(LV00Engine *engine, ConstraintGraph *construction, ConstraintGraph *proposition);
...
LV00_PUBLIC_API EngineStatus engine_get_last_status(const LV00Engine *engine);
/**
 ...
 * 示例:
 * @code
 LV00_PUBLIC_API *   EngineStatus status = engine_get_last_status(engine);
 LV00_PUBLIC_API *   printf("操作结果: %s\n", engine_status_to_string(status));
 * @endcode
 */
LV00_PUBLIC_API const char *engine_status_to_string(EngineStatus status);
 ...
 */
LV00_PUBLIC_API const char *engine_status_to_identifier(EngineStatus status);
 ...
 */
LV00_PUBLIC_API const char *engine_status_get_description(EngineStatus status);
...
LV00_PUBLIC_API EngineSolveResult engine_solve(LV00Engine *engine);

/* 重写-求解工作流，实现协作协议：
 * 先重写 -> 遇停顿则求解 -> 冲突暴露。
 * 返回总执行步数，出错返回负值。 */
LV00_PUBLIC_API int engine_rewrite_and_solve(LV00Engine *engine, int max_rewrite_steps, int max_solve_steps);
...
LV00_PUBLIC_API EngineCircuitResult engine_handle_circuit_trip(LV00Engine *engine);
...
LV00_PUBLIC_API EngineCircuitResult engine_handle_circuit_trip_with_action(LV00Engine *engine, EngineCircuitAction action);
 ...
 */
LV00_PUBLIC_API void engine_set_rewrite_step_limit(LV00Engine *engine, int limit);
 ...
 */
LV00_PUBLIC_API int engine_get_rewrite_step_limit(const LV00Engine *engine);
 ...
 */
LV00_PUBLIC_API void *engine_create_frozen_point(LV00Engine *engine);
 ...
 */
LV00_PUBLIC_API void engine_destroy_frozen_point(void *frozen_point);
 ...
 */
LV00_PUBLIC_API StreamContext *engine_get_stream_context(const LV00Engine *engine);
 ...
 */
LV00_PUBLIC_API void engine_set_streaming_enabled(LV00Engine *engine, bool enabled);
 ...
 */
LV00_PUBLIC_API bool engine_is_streaming_enabled(const LV00Engine *engine);
 ...
 */
LV00_PUBLIC_API void engine_emit_stream_event(LV00Engine *engine, StreamEventType type, const char *description, int step_number,
 ...
 */
LV00_PUBLIC_API EngineStatus lv00_engine_transition_state(LV00Engine *engine, EngineState new_state);
 ...
 * @return 当前状态枚举值
 */
LV00_PUBLIC_API EngineState engine_get_state(const LV00Engine *engine);
 ...
 */
LV00_PUBLIC_API bool engine_is_busy(const LV00Engine *engine);
 ...
 */
LV00_PUBLIC_API const char *engine_state_name(EngineState state);
 ...
 */
LV00_PUBLIC_API bool engine_is_valid_transition(EngineState from, EngineState to);
