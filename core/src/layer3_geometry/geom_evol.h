 ...
 */
typedef int (*Lv00GeomEvolRHSFunc)(double t, const double *param, double *dparam, Lv00GeomEvol *evol);
 ...
 * @param[in] param 当前参数
 */
typedef void (*Lv00GeomEvolPostStepFunc)(const Lv00GeomEvol *evol, double t, const double *param);
 ...
 * @return 成功返回 0
 */
typedef int (*Lv00GeomEvolRootFunc)(double t, const double *param, double *gout, Lv00GeomEvol *evol);
 ...
 */
Lv00GeomEvol *geoevol_create(int dim, Lv00EvolMethod method, Lv00GeomEvolRHSFunc rhs);
 ...
 */
void geoevol_set_step(Lv00GeomEvol *evol, double step_size, double step_min, double step_max);
 ...
 */
static inline const Lv00GeomEvolStats *geoevol_get_step_stats(const Lv00GeomEvol *evol) {
 ...
 */
static inline double geoevol_pi_predict(Lv00GeomEvolPI *pi, double error, int order, double h_curr) {
