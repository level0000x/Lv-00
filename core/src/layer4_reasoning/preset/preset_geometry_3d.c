...
bool preset_geometry_3d_register(void)
{
...

    {
        ...
        REGISTER_3D(
            ...
            "构造四面体的重心 G = (A+B+C+D)/4",
            inputs, 4, PRESET_TYPE_POINT,
            "G = (A + B + C + D) / 4，四条顶点到对面重心连线的交点",
            "O(1)", true, false);
    }
...

    {
        ...
        REGISTER_3D(
            ...
            "平面 π1(P1,P2,P3) 与 π2(P1,P2,P4) 的交线",
            "O(1)", true, false);
    }
...

    {
        ...
        REGISTER_3D(
            ...
            "构造过给定直线且垂直于给定平面的平面",
            inputs, 4, PRESET_TYPE_POLYGON,
            "过直线 L(P1,P2) 且垂直于平面 π(P1,P2,P3) 的平面",
            "O(1)", true, false);
    }

    {
        ...
        REGISTER_3D(
            ...
            "构造两平面的角平分面",
            inputs, 4, PRESET_TYPE_POLYGON,
            "平面 π1(P1,P2,P3) 与 π2(P1,P2,P4) 的角平分面",
            "O(1)", true, false);
    }
...

    {
        ...
        REGISTER_3D(
            ...
            "关于点的中心对称",
            inputs, 2, PRESET_TYPE_POINT,
            "点 P 关于中心 O 的对称点 P'，满足 O 是 PP' 中点",
            "O(1)", true, true);
    }
...

    {
        ...
        REGISTER_3D(
            ...
            "判断两平面是否平行",
            inputs, 4, PRESET_TYPE_BOOLEAN,
            "判断平面 π1(P1,P2,P3) 与 π2(P1,P2,P4) 是否平行",
            "O(1)", false, false);
    }

    {
        ...
        REGISTER_3D(
            ...
            "判断两平面是否垂直",
            inputs, 4, PRESET_TYPE_BOOLEAN,
            "判断平面 π1(P1,P2,P3) 与 π2(P1,P2,P4) 是否垂直",
            "O(1)", false, false);
    }

    {
        ...
        REGISTER_3D(
            ...
            "判断直线与平面是否平行",
            inputs, 4, PRESET_TYPE_BOOLEAN,
            "判断直线 L(P1,P2) 与平面 π(P1,P2,P3) 是否平行",
            "O(1)", false, false);
    }

    {
        ...
        REGISTER_3D(
            ...
            "判断直线与平面是否垂直",
            inputs, 4, PRESET_TYPE_BOOLEAN,
            "判断直线 L(P1,P2) 与平面 π(P1,P2,P3) 是否垂直",
            "O(1)", false, false);
    }
...

    {
        ...
        REGISTER_3D(
            ...
            "计算三平面的交点",
            inputs, 4, PRESET_TYPE_POINT,
            "三平面 π1, π2, π3 的公共交点（当三平面不平行于同一直线时）",
            "O(1)", true, false);
    }
...

    {
        ...
        REGISTER_3D(
            ...
            "计算两球的交线（圆）",
            inputs, 4, PRESET_TYPE_CIRCLE,
            "球 S1(O1,R1) 与 S2(O2,R2) 的交线（当两球相交时）",
            "O(1)", true, false);
    }
...

    {
        ...
        REGISTER_3D(
            ...
            "计算直线与平面的夹角",
            inputs, 4, PRESET_TYPE_SCALAR,
            "sin(θ) = |v·n|/(|v||n|)，其中 v 为方向向量，n 为法向量",
            "O(1)", false, false);
    }
