...
static const char *quant_name_lookup(const quant_NameEntry *table, size_t count, int code) {
...
static const quant_NameEntry s_lv_quant_to_string_entries[] = {
    {lv_FORALL, "\xe2\x88\x80"},
    {lv_EXISTS, "\xe2\x88\x83"},
    {lv_EXISTS_UNIQUE, "\xe2\x88\x83!"},
};

const char *lv_quant_to_string(lvQuantifier q) {
    const char *name = quant_name_lookup(s_lv_quant_to_string_entries, lv_ARRAY_SIZE(s_lv_quant_to_string_entries), (int) q);
...
static const quant_NameEntry s_lv_quant_result_to_string_entries[] = {
    {lv_QUANT_OK, "操作成功"},
    {lv_QUANT_DOMAIN_EMPTY, "域为空"},
...
const char *lv_quant_result_to_string(lvQuantResult result) {
    const char *name = quant_name_lookup(s_lv_quant_result_to_string_entries, lv_ARRAY_SIZE(s_lv_quant_result_to_string_entries), (int) result);
    return name ? name : "未知结果";
}
