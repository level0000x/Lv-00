...
static Lv00Config *cfg_mut(void) {
    lv00_config_current(); /* ensure initialized */
    return &g_active_config;
}

void lv00_config_set_solver_max_var_id(int val)       { cfg_mut()->solver_max_var_id = val; }
void lv00_config_set_solver_max_iterations(int val)    { cfg_mut()->solver_max_iterations = val; }
void lv00_config_set_proof_max_depth(int val)           { cfg_mut()->proof_max_depth = val; }
void lv00_config_set_proof_max_branches(int val)        { cfg_mut()->proof_max_branches = val; }
void lv00_config_set_proto_max_draw_cmds(int val)       { cfg_mut()->proto_max_draw_cmds = val; }
void lv00_config_set_proto_max_proof_steps(int val)     { cfg_mut()->proto_max_proof_steps = val; }
void lv00_config_set_proto_max_terminal_lines(int val)  { cfg_mut()->proto_max_terminal_lines = val; }
void lv00_config_set_geo_max_objects(int val)           { cfg_mut()->geo_max_objects = val; }
void lv00_config_set_geo_max_constraints(int val)       { cfg_mut()->geo_max_constraints = val; }
void lv00_config_set_geo_min_zoom(double val)           { cfg_mut()->geo_min_zoom = val; }
void lv00_config_set_geo_max_zoom(double val)           { cfg_mut()->geo_max_zoom = val; }
void lv00_config_set_parser_max_input_length(int val)   { cfg_mut()->parser_max_input_length = val; }
void lv00_config_set_parser_max_ast_nodes(int val)      { cfg_mut()->parser_max_ast_nodes = val; }
void lv00_config_set_max_recursion_depth(int val)       { cfg_mut()->max_recursion_depth = val; }
void lv00_config_set_default_rewrite_limit(int val)     { cfg_mut()->default_rewrite_limit = val; }
void lv00_config_set_geoevol_max_param_dim(int val)     { cfg_mut()->geoevol_max_param_dim = val; }
void lv00_config_set_geoevol_max_rejections(int val)    { cfg_mut()->geoevol_max_rejections = val; }
void lv00_config_set_stream_max_callbacks(int val)      { cfg_mut()->stream_max_callbacks = val; }
void lv00_config_set_max_plugins(int val)               { cfg_mut()->max_plugins = val; }
