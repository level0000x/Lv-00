 ...
 * Test 2 模板校验为混合 wrapper（含文件特有参数校验），保留在下方）
 * ============================================================ */

static const AxiomTestCase kCases[] = {
    {
        .pkg_path = AXIOM_PKG_PATH,
        .pkg_name = "classical_propositional_logic",
        ...
        .lf_bottom_geometry = "classical_propositional_2valued",
        .lf_negation_encoding = "material_implication_to_falsum",
...
TEST_MAIN_BEGIN("Classical Propositional Logic")
    LV_REGISTER_AXIOM_CASES("ClassicalPropositionalLogic", kCases, K_CASES_COUNT);
