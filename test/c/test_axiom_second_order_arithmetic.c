...
static const AxiomTestCase kCases[] = {
    {
        ...
        .pkg_name = "second_order_arithmetic",
        ...
        .tmpl_count_msg = "should have 135 constraint templates",
        ...
        .lf_bottom_geometry = "second_order_arithmetic_natural_numbers",
...
TEST_MAIN_BEGIN("Second-Order Arithmetic Axiom Package Tests")
    LV_REGISTER_AXIOM_CASES("SecondOrderArithmetic", kCases, K_CASES_COUNT);
