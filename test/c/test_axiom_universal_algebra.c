...
static const AxiomTestCase kCases[] = {
    {
        ...
        .lf_bottom_geometry = "universal_algebra_equational",
        .lf_negation_encoding = "equational_equality",
...
TEST_MAIN_BEGIN("Universal Algebra")
    LV_REGISTER_AXIOM_CASES("UniversalAlgebra", kCases, K_CASES_COUNT);
