...
static void test_load_from_file(void) {
    axiom_test_load_from_file(AXIOM_PKG_PATH, "non_well_founded_set_theory");
}
...
static void test_logical_framework(void) {
    axiom_test_logical_framework(AXIOM_PKG_PATH, "hyperset_graph_universe",
                                 "classical_complement_in_hyperset_universe", PROPOSITION_KIND_EXPLOSION_PRINCIPLE,
