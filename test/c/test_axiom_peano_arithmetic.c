...
static const AxiomTestCase kCases[] = {
    {
        ...
        .lf_bottom_geometry = "peano_arithmetic_discrete",
        .lf_negation_encoding = "classical_first_order_logic",
...
TEST_MAIN_BEGIN("Peano Arithmetic")
    LV_REGISTER_AXIOM_CASES("PeanoArithmetic", kCases, K_CASES_COUNT);
