...
static void test_load_from_file(void) {
    axiom_test_load_from_file(AXIOM_PKG_PATH, "algebraic_geometry");
}
...
static void test_save_load_roundtrip(void) {
    axiom_test_round_trip_save_load(AXIOM_PKG_PATH, SAVE_TEST_PATH, "algebraic_geometry", EXPECTED_TEMPLATE_COUNT,
