...
static void test_dependency_validation(void) {
    ...
    TEST_ASSERT(uc->dependency_count >= 1, "quantum_separability_problem should have at least 1 dependency");

    uc = axiom_package_lookup_unconstructible(pkg, "bqp_vs_np");
    TEST_ASSERT(uc != NULL, "bqp_vs_np should exist");
    TEST_ASSERT(uc->dependency_count >= 1, "bqp_vs_np should have at least 1 dependency");
