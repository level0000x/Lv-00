...
static void test_load_from_file(void) {
    ...
    TEST_ASSERT(pkg->name != NULL && strcmp(pkg->name, "real_analysis") == 0, "package name should be 'real_analysis'");
...
static void test_templates(void) {
    ...
    TEST_ASSERT(axiom_package_get_template_count(pkg) == EXPECTED_TEMPLATE_COUNT, "should have 43 constraint templates");
...
static void test_save_load_roundtrip(void) {
    ...
    TEST_ASSERT(strcmp(pkg2->name, "real_analysis") == 0, "reloaded package should have same name");
